...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#datalkesubkomponen').off('submit').on('submit', function(e) {
...
<div class="data-lkesubkomponen-form">

    <?php
    $form = ActiveForm::begin([
        'id' => 'datalkesubkomponen',
        'options' => ['enctype' => 'multipart/form-data'],
    ]);
    ?>


    <?= $form->field($model, 'reflkekomponen_id')->hiddenInput()->label(false) ?>

    <div class="form-group">
        <label for="reflkekomponen_id">LKE Komponen</label>
        <input type="text" id="reflkekomponen_id" class="form-control" value="<?= $model->refLkekomponen->uraian_lkekomponen ?>" readonly>
    </div>

    <?= $form->field($model, 'reflkesubkomponen_id')->hiddenInput()->label(false) ?>

    <div class="form-group">
        <label for="reflkesubkomponen_id">LKE Sub Komponen</label>
        <input type="text" id="reflkesubkomponen_id" class="form-control" value="<?= $model->refLkesubkomponen->uraian_lkesubkomponen ?>" readonly>
    </div>

    <?= $form->field($model, 'uraian_lkesubkriteria')->textarea(['rows' => 6])->label('LKE Kriteria Sub Komponen') ?>
