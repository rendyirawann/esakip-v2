...
$this->title = 'View Data SAKIP Misi Perubahan - ' . $model->uraian_misi_p;
  ...
  <div class="pc-content">
        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="<?= Url::to(['/sakip-misi-p/index']) ?>">Data SAKIP Misi Perubahan</a></li>
              <li class="breadcrumb-item" aria-current="page">View Data SAKIP Misi Perubahan</li>
            </ul>
          </div>
          <div class="col-md-12">
            <div class="page-header-title">
              <h2 class="mb-0">View Data SAKIP Misi Perubahan</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h1>View Data SAKIP Misi Perubahan - <?= Html::encode($model->refmisi_p_id) ?></h1>
            ...
            <p>
              ...
              <?= Html::a('Delete', ['delete', 'refmisi_p_id' => $model->refmisi_p_id], [
            ...
            <?= DetailView::widget([
              ...
              'attributes' => [
                ...
                [
                  ...
                  'value' => function ($model) {
                    return $model->visi ? $model->visi->uraian_visi_p : 'Tidak ada visi';
                  },
                ],
                [
