...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#dataperiode').off('submit').on('submit', function(e) {
...
<?= $form->field($model, 'periode')->textInput(['maxlength' => true])->label('Periode Tahun') ?>

<?= $form->field($model, 'refperiode_5tahun_id')->dropDownList(
    ArrayHelper::map(\backend\models\SakipPeriode5tahun::find()->all(), 'refperiode_5tahun_id', 'nama_periode'),
    ['prompt' => 'Pilih Periode 5 Tahun', 'data-trigger' => '']
)->label('Periode 5 Tahun') ?>

<?= $form->field($model, 'periode_isaktif')->radioList(
