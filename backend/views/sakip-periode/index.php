...
/** @var backend\models\search\SakipPeriodeSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Sakip Periode';
        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page">Data SAKIP Periode</li>
            </ul>
          </div>
          <div class="col-md-12">
            <div class="page-header-title">
              <h2 class="mb-0">Data SAKIP Periode</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <?php endif; ?>
            <?= Html::button('Tambah Data SAKIP Periode', [
                ...
                <tbody>
                  ...
                  <?php foreach ($dataProvider->models as $model) : ?>
                    <tr>
                      ...
                      <td><?= Html::encode($model->periode5Tahun ? $model->periode5Tahun->nama_periode : '-') ?></td>
                      <td>
                        <?php if ($model->periode_isaktif === 'T'): ?>
                          <span class="btn btn-success btn-sm">Aktif</span>
                        <?php elseif ($model->periode_isaktif === 'F'): ?>
                          <span class="btn btn-warning btn-sm">Tidak Aktif</span>
                        <?php endif; ?>
                      </td>
                      <td style="width: 150px;">
                        <button type="button" class="btn btn-primary btn-sm" title="View" data-bs-toggle="modal" data-bs-target="#myModal<?= $model->refperiode_id ?>">
                        ...
                        <?= Html::a('<i class="fas fa-trash-alt"></i>', ['delete', 'refperiode_id' => $model->refperiode_id], [
            ...
            <!-- Modal -->
            <?php foreach ($dataProvider->models as $model) : ?>
              <div class="modal fade" id="myModal<?= $model->refperiode_id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <?= Html::a('<i class="fas fa-eye"> </i>', ['view', 'refperiode_id' => $model->refperiode_id], ['class' => 'btn btn-info ml-2', 'title' => 'View']) ?>
