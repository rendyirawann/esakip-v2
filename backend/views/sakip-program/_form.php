...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#dataprogram').off('submit').on('submit', function(e) {
...
<div class="sakip-program-form">
    ...
    <?= $form->field($model, 'refurusan_id')->dropDownList(
        ...
        [
            ...
            $.post("' . Url::to(['sakip-program/lists', 'id' => '']) . '"+urusanId, function(data) {
                var bidangDropdown = $("select#sakipprogram-refbidang_id");
                bidangDropdown.html(data).val("");
                bidangDropdown.prepend("<option value=\"\">Pilih Bidang</option>");
            });'
        ]
    ...
    <?= $form->field($model, 'program_isaktif')->radioList(
