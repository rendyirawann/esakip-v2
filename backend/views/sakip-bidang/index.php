      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <?php endif; ?>
            <?= Html::button('Tambah Data SAKIP Bidang', [
                ...
                <tbody>
                  ...
                  <?php foreach ($dataProvider->models as $model) : ?>
                    <tr>
                      ...
                      <td><?= Html::encode($model->kode_bidang) ?></td>
                      <td><?= Html::encode($model->nama_bidang) ?></td>
                      <td>
                        <?php if ($model->bidang_isaktif === 'T'): ?>
                          <span class="btn btn-success btn-sm">Aktif</span>
                        <?php elseif ($model->bidang_isaktif === 'F'): ?>
                          <span class="btn btn-warning btn-sm">Tidak Aktif</span>
                        <?php endif; ?>
                      </td>
                      <td style="width: 150px;">
                        <button type="button" class="btn btn-primary btn-sm" title="View" data-bs-toggle="modal" data-bs-target="#myModal<?= $model->refbidang_id ?>">
                        ...
                        <?= Html::a('<i class="fas fa-trash-alt"></i>', ['delete', 'refbidang_id' => $model->refbidang_id], [
            ...
            <!-- Modal -->
            <?php foreach ($dataProvider->models as $model) : ?>
              <div class="modal fade" id="myModal<?= $model->refbidang_id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Detail Data Bidang</h5>
                    </div>
                    ...
                    <div class="modal-footer">
                      <?= Html::a('<i class="fas fa-eye"> </i>', ['view', 'refbidang_id' => $model->refbidang_id], ['class' => 'btn btn-info ml-2', 'title' => 'View']) ?>
