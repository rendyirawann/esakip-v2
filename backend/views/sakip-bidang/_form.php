...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#databidang').off('submit').on('submit', function(e) {
...
<div class="data-bidang-form">
    ...
    <?= $form->field($model, 'kode_bidang')->textInput(['maxlength' => true])->label('Kode') ?>

    <?= $form->field($model, 'nama_bidang')->textarea(['rows' => 6])->label('Nama Bidang') ?>

    <?= $form->field($model, 'bidang_isaktif')->radioList(
    ...
    <?= $form->field($model, 'refurusan_id')->dropDownList(
        ...
        ['prompt' => 'Pilih Urusan', 'data-trigger' => '']
