...
$this->title = 'View Data SAKIP Visi - ' . $model->uraian_visi;
  ...
  <div class="pc-content">
        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="<?= Url::to(['/sakip-visi/index']) ?>">Data SAKIP Visi</a></li>
              <li class="breadcrumb-item" aria-current="page">View Data SAKIP Visi</li>
            </ul>
          </div>
          <div class="col-md-12">
            <div class="page-header-title">
              <h2 class="mb-0">View Data SAKIP Visi</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h1>View Data SAKIP Visi - <?= Html::encode($model->refvisi_id) ?></h1>
