...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#datalkekomponen').off('submit').on('submit', function(e) {
...
<div class="data-lkekomponen-form">
    ...
    <?= $form->field($model, 'uraian_lkekomponen')->textarea(['rows' => 6])->label('LKE Komponen') ?>
