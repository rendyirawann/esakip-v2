...
/** @var backend\models\search\SakipSasaranSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Sakip Sasaran';
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Data SAKIP Sasaran</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Data SAKIP Sasaran</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <?= Html::button('Tambah Data SAKIP Sasaran', [
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($dataProvider->models as $model) : ?>
                                        <tr>
                                            ...
                                            <td style="white-space: pre-wrap;"><?= Html::decode($model->uraian_sasaran) ?></td>
                                            ...
                                            <td style="width: 150px;">
                                                ...
                                                <?= Html::a('<i class="fas fa-trash-alt"></i>', ['delete', 'refsasaran_id' => $model->refsasaran_id], [
                                                ...
                                                <?= Html::a('<i class="fas fa-copy"></i>', ['duplicate', 'refsasaran_id' => $model->refsasaran_id], [
                        ...
                        <!-- Modal -->
                        <?php foreach ($dataProvider->models as $model) : ?>
                            <div class="modal fade" id="myModal<?= $model->refsasaran_id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-xl" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Detail Data Sasaran</h5>
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                            <?= Html::a('<i class="fas fa-eye"> </i>', ['view', 'refsasaran_id' => $model->refsasaran_id], ['class' => 'btn btn-info ml-2', 'title' => 'View']) ?>
