...
<div class="data-lkesubkomponen-form">
    ...
    <?= $form->field($model, 'uraian_lkesubkomponen')->textarea(['rows' => 6])->label('LKE Sub Komponen') ?>

    <?= $form->field($model, 'bobot_lkesubkomponen')->textInput(['maxlength' => true])->label('Bobot Nilai') ?>
