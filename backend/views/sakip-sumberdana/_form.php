...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#datasumberdana').off('submit').on('submit', function(e) {
...
<div class="sakip-sumberdana-form">
...
?>
    ...
    <?= $form->field($model, 'kode_sumberdana')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'nama_sumberdana')->textarea(['rows' => 6]) ?>

    <?= $form->field($model, 'sumberdana_isaktif')->radioList(
