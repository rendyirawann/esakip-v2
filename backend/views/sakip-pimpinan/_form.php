...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#datapimpinan').off('submit').on('submit', function(e) {
...
<div class="sakip-pimpinan-form">
    ...
    <?= $form->field($model, 'refperiode_id')->dropDownList(
        ...
        ['prompt' => 'Pilih Periode Tahun']
    )->label('Periode Tahun') ?>

    <?= $form->field($model, 'nama_pimpinan')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'jabatan_pimpinan')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'nama_wpimpinan')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'jabatan_wpimpinan')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'user_edit')->textInput([
        'maxlength' => true,
        'value' => Yii::$app->user->identity->username, // Automatically set the current user's username
        'readonly' => true // Make the field read-only
    ]) ?>

    <?= $form->field($model, 'date_edit')->textInput([
        'value' => date('Y-m-d H:i:s'), // Automatically set current datetime
        'readonly' => true // Make the field read-only
    ]) ?>
