...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#datasubunit').off('submit').on('submit', function(e) {
...
?>
    ...
    <?= $form->field($model, 'kode_subunit')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'nama_subunit')->textarea(['rows' => 6]) ?>

    <?= $form->field($model, 'subunit_isaktif')->radioList(
