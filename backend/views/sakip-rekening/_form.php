...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#datarekening').off('submit').on('submit', function(e) {
...
?>
    ...
    <?= $form->field($model, 'nama_rekening')->textarea(['rows' => 6]) ?>

    <?= $form->field($model, 'rekening_isaktif')->radioList(
