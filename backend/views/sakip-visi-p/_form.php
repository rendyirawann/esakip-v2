...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#datavisip').off('submit').on('submit', function(e) {
...
<div class="data-visi-p-form">
    ...
    <?= $form->field($model, 'uraian_visi_p')->widget(CKEditor::className(), [
        'options' => ['rows' => 5],
        'preset' => 'full'
    ]); ?>


    <?= $form->field($model, 'penjabaran_visi_p')->widget(CKEditor::className(), [
        'options' => ['rows' => 5],
        'preset' => 'full'
    ]); ?>
    ...
    <?= $form->field($model, 'visi_p_isaktif')->radioList(
