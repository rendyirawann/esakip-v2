...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#databidangbappeda').off('submit').on('submit', function(e) {
...
<div class="data-bidangbappeda-form">

    <?php
    $form = ActiveForm::begin([
        'id' => 'databidangbappeda',
        'options' => ['enctype' => 'multipart/form-data'],
    ]);
    ?>

    <?= $form->field($model, 'nama_bidangbappeda')->textInput(['maxlength' => true])->label('Bidang Bappeda') ?>
