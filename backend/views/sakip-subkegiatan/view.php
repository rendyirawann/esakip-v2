...
$this->title = 'View Data SAKIP Sub Kegiatan - ' . $model->nama_subkegiatan;
  ...
  <div class="pc-content">
        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="<?= Url::to(['/sakip-subkegiatan/index']) ?>">Data SAKIP Sub Kegiatan</a></li>
              <li class="breadcrumb-item" aria-current="page">View Data SAKIP Sub Kegiatan</li>
            </ul>
          </div>
          <div class="col-md-12">
            <div class="page-header-title">
              <h2 class="mb-0">View Data SAKIP Sub Kegiatan</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h1>View Data SAKIP Sub Kegiatan - <?= Html::encode($model->refsubkegiatan_id) ?></h1>
            ...
            <?= Html::button('Update', [
              ...
              <?= Html::a('Delete', ['delete', 'refsubkegiatan_id' => $model->refsubkegiatan_id], [
