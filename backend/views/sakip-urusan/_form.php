...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#dataurusan').off('submit').on('submit', function(e) {
...
<?= $form->field($model, 'kode_urusan')->textInput(['maxlength' => true])->label('Kode') ?>

<?= $form->field($model, 'nama_urusan')->textarea(['rows' => 6])->label('Nama Urusan') ?>

<?= $form->field($model, 'urusan_isaktif')->radioList(
