...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#datasatuanharga').off('submit').on('submit', function(e) {
...
<div class="sakip-satuanharga-form">
...
?>
    ...
    <?= $form->field($model, 'kode_satuanharga')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'nama_satuanharga')->textarea(['rows' => 6]) ?>

    <?= $form->field($model, 'satuanharga_isaktif')->radioList(
