...
/** @var backend\models\search\SakipSkpdSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Data SAKIP SKPD';
        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page">Data SAKIP SKPD</li>
            </ul>
          </div>
          <div class="col-md-12">
            <div class="page-header-title">
              <h2 class="mb-0">Data SAKIP SKPD</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <?php endif; ?>
            <?= Html::button('Tambah Data SAKIP SKPD', [
                ...
                <tbody>
                  ...
                  <?php foreach ($dataProvider->models as $model) : ?>
                    <tr>
                      ...
                      <td><?= Html::encode($model->nama_skpd) ?></td>
                      <td>
                        <?php if ($model->skpd_isaktif === 'T'): ?>
                          <span class="btn btn-success btn-sm">Aktif</span>
                        <?php elseif ($model->skpd_isaktif === 'F'): ?>
                          <span class="btn btn-warning btn-sm">Tidak Aktif</span>
                        <?php endif; ?>
                      </td>
                      <td style="width: 150px;">
                        <button type="button" class="btn btn-primary btn-sm" title="View" data-bs-toggle="modal" data-bs-target="#myModal<?= $model->refskpd_id ?>">
                        ...
                        <?= Html::a('<i class="fas fa-trash-alt"></i>', ['delete', 'refskpd_id' => $model->refskpd_id], [
                        ...
                        <?= Html::button('<i class="fas fa-check"></i> Lengkapi Data SKPD', [
                          'class' => 'btn btn-success btn-sm',
                          'data-bs-toggle' => 'modal',
            ...
            <!-- Modal -->
            <?php foreach ($dataProvider->models as $model) : ?>
              <div class="modal fade" id="myModal<?= $model->refskpd_id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Detail Data SKPD</h5>
                    </div>
                    ...
                    <div class="modal-footer">
                      <?= Html::a('<i class="fas fa-eye"> </i>', ['view', 'refskpd_id' => $model->refskpd_id], ['class' => 'btn btn-info ml-2', 'title' => 'View']) ?>
