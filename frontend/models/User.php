...
class User extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['refskpd_id', 'refpegawai_id', 'kode_group', 'status', 'created_at', 'updated_at'], 'integer'],
            [['user_lastlogin', 'password_real'], 'safe'],
    ...
    {
        return $this->hasMany(SakipKoordinasi::class, ['refuser_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(UserGroup::class, ['kode_group' => 'kode_group']);
    }

    /**
     * Defines relation to userAttemptlogin table
     */
    public function getUserAttemptlogin()
    {
        return $this->hasMany(UserAttemptlogin::class, ['id' => 'id']);
    }
