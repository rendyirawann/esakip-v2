...
class UserSearch extends User
{
    ...
    {
        return [
            [['id', 'refskpd_id', 'refpegawai_id', 'kode_group', 'status', 'created_at', 'updated_at'], 'integer'],
            [['username', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'nama_user', 'no_hp', 'otp', 'user_lastlogin', 'user_lastloginip', 'user_isonline'], 'safe'],
        ];
    }
