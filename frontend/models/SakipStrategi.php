...
/**
 * This is the model class for table "v2_sakip_strategi".
 *
 * @property int $refstrategi_id
 * @property string $uraian_strategi
 ...
 */
class SakipStrategi extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            // [['uraian_strategi'], 'required'],
            [['uraian_strategi'], 'required', 'message' => 'Data tidak boleh kosong.'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'uraian_strategi' => 'Uraian Strategi',
