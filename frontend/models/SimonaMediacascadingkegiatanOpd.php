...
/**
 * This is the model class for table "simona_mediacascadingkegiatan_opd".
 *
 * @property int $refsimonamediacascadingkegiatanopd_id
 ...
 */
class SimonaMediacascadingkegiatanOpd extends \yii\db\ActiveRecord
{
    public $file_docs;
    /**
     * {@inheritdoc}
    ...
    {
        return 'simona_mediacascadingkegiatan_opd';
    }
    ...
    {
        return [
            [['refsimonacascadingkegiatan_id', 'refuser_id', 'refskpd_id'], 'integer'],
            [['nama_file'], 'string'],
    ...
    {
        return [
            'refsimonamediacascadingkegiatanopd_id' => 'Refsimonamediacascadingkegiatanopd ID',
