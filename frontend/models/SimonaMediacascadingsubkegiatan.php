...
/**
 * This is the model class for table "simona_mediacascadingsubkegiatan".
 *
 * @property int $refsimonamediacascadingsubkegiatan_id
 ...
 */
class SimonaMediacascadingsubkegiatan extends \yii\db\ActiveRecord
{
    public $file_docs;
    /**
     * {@inheritdoc}
    ...
    {
        return 'simona_mediacascadingsubkegiatan';
    }
    ...
    {
        return [
            'refsimonamediacascadingsubkegiatan_id' => 'Refsimonamediacascadingsubkegiatan ID',
