...
/**
 * This is the model class for table "simona_mediacascadingkegiatan".
 *
 * @property int $refsimonamediacascadingkegiatan_id
 ...
 */
class SimonaMediacascadingkegiatan extends \yii\db\ActiveRecord
{
    public $file_docs;
    /**
     * {@inheritdoc}
    ...
    {
        return 'simona_mediacascadingkegiatan';
    }
    ...
    {
        return [
            'refsimonamediacascadingkegiatan_id' => 'Refsimonamediacascadingkegiatan ID',
