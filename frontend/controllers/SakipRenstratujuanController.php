...
use frontend\models\search\SakipRenstratujuanSearch;
...
/**
 * SakipRenstratujuanController implements the CRUD actions for SakipRenstratujuan model.
 */
class SakipRenstratujuanController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all SakipRenstratujuan models.
     *
     * @return string
     */
    public function actionIndex($refperiode_id = null)
    {
        $searchModel = new SakipRenstratujuanSearch();
    ...
    /**
     * Displays a single SakipRenstratujuan model.
     * @param int $refrenstratujuan_id Refstrategi ID
     * @return string
     * @throws NotFoundHttpException if the model cannot be found refrenstratujuan_id
     */
    public function actionView($refrenstratujuan_id)
    {
        return $this->render('view', [
            'model' => $this->findModel($refrenstratujuan_id),
        ]);
    }

    /**
     * Creates a new SakipRenstratujuan model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate($refsasaranrenstra_id = null, $refperiode_id = null)
    {
        $model = new SakipRenstratujuan();
    ...
    /**
     * Updates an existing SakipRenstratujuan model.
     * If update is successful, the browser will be redirected to the 'view' page.
     * @param int $refrenstratujuan_id Refstrategi ID
     * @return string|\yii\web\Response
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($refrenstratujuan_id, $refperiode_id = null)
    {
        $model = $this->findModel($refrenstratujuan_id);
    ...
    /**
     * Deletes an existing SakipRenstratujuan model.
     * If deletion is successful, the browser will be redirected to the 'index' page.
     * @param int $refrenstratujuan_id Refstrategi ID
     * @return \yii\web\Response
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($refrenstratujuan_id)
    {
        $model = $this->findModel($refrenstratujuan_id);
    ...
    /**
     * Finds the SakipRenstratujuan model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $refrenstratujuan_id Refstrategi ID
     * @return SakipRenstratujuan the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($refrenstratujuan_id)
    {
        if (($model = SakipRenstratujuan::findOne(['refrenstratujuan_id' => $refrenstratujuan_id])) !== null) {
            return $model;
        }
