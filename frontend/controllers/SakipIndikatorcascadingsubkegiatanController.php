...
use frontend\models\search\SakipIndikatorcascadingsubkegiatanSearch;
...
/**
 * SakipIndikatorcascadingsubkegiatanController implements the CRUD actions for SakipIndikatorcascadingsubkegiatan model.
 */
class SakipIndikatorcascadingsubkegiatanController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all SakipIndikatorcascadingsubkegiatan models.
     *
     * @return string
     */
    public function actionIndex($refperiode_id = null)
    {
        $searchModel = new SakipIndikatorcascadingsubkegiatanSearch();
        ...
        $query = SakipIndikatorcascadingsubkegiatan::find()->where(['refskpd_id' => $refskpd_id]);
    ...
    /**
     * Displays a single SakipIndikatorcascadingsubkegiatan model.
     * @param int $refindikatorsubkegiatan_id Refindikatorsubkegiatan ID
     * @return string
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionView($refindikatorsubkegiatan_id)
    {
        return $this->render('view', [
            'model' => $this->findModel($refindikatorsubkegiatan_id),
        ]);
    }

    /**
     * Creates a new SakipIndikatorcascadingsubkegiatan model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new SakipIndikatorcascadingsubkegiatan();

        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                return $this->redirect(['view', 'refindikatorsubkegiatan_id' => $model->refindikatorsubkegiatan_id]);
            }
        } else {
    ...
    /**
     * Updates an existing SakipIndikatorcascadingsubkegiatan model.
     * If update is successful, the browser will be redirected to the 'view' page.
     * @param int $refindikatorsubkegiatan_id Refindikatorsubkegiatan ID
     * @return string|\yii\web\Response
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($refindikatorsubkegiatan_id, $refperiode_id = null)
    {
        $model = $this->findModel($refindikatorsubkegiatan_id);
                ...
                if ($model->save()) {
                    ...
                    for ($i = 1; $i <= 4; $i++) {
                        ...
                        $triwulanModel = SakipIndikatorcascadingsubkegiatanTriwulan::findOne([
                            'refindikatorsubkegiatan_id' => $model->refindikatorsubkegiatan_id,
                            'reftriwulan_id' => $i
                        ]);
                    ...
                    if (strpos($referrer, 'index-rkt-dev') !== false) {
                        $redirectUrl = \yii\helpers\Url::to(['sakip-indikatorcascadingsubkegiatan/index-rkt-dev', 'refperiode_id' => $model->refperiode_id, 'refskpd_id' => $model->refskpd_id]);
                    }
    ...
    public function actionUpdateAnggaranRkt($refindikatorsubkegiatan_id, $refperiode_id = null)
    {
        $model = $this->findModel($refindikatorsubkegiatan_id);

        if (Yii::$app->request->isAjax) {
            if ($model->load(Yii::$app->request->post())) {
                $model->anggaran_rkt = str_replace('.', '', $model->anggaran_rkt);
                $model->anggaran_pk = $model->anggaran_rkt;
                ...
                if ($model->save()) {
                    ...
                    if (strpos($referrer, 'index-anggaran-rkt-dev') !== false) {
                        $redirectUrl = \yii\helpers\Url::to(['sakip-indikatorcascadingsubkegiatan/index-anggaran-rkt-dev', 'refperiode_id' => $model->refperiode_id, 'refskpd_id' => $model->refskpd_id]);
                    }
                    return $this->asJson(['success' => true, 'redirect' => $redirectUrl]);
                } else {
                    // Log error jika model utama gagal disimpan
            ...
            return $this->renderAjax('_formanggaranrkt', [
                'model' => $model,
            ]);
        }

        return $this->render('update-anggaran-rkt', [
            'model' => $model,
        ]);
    }

    public function actionUpdateTargetPk($refindikatorsubkegiatan_id, $refperiode_id = null)
    {
        $model = $this->findModel($refindikatorsubkegiatan_id);
    ...
    public function actionUpdateTargetPkp($refindikatorsubkegiatan_id, $refperiode_id = null)
    {
        $model = $this->findModel($refindikatorsubkegiatan_id);
    ...
    public function actionUpdateTargetCapaian($refindikatorsubkegiatan_id, $refperiode_id = null)
    {
        $model = $this->findModel($refindikatorsubkegiatan_id);
    ...
    public function actionUpdateAnggaranPk($refindikatorsubkegiatan_id, $refperiode_id = null)
    {
        $model = $this->findModel($refindikatorsubkegiatan_id);
        ...
        if (Yii::$app->request->isAjax) {
            if ($model->load(Yii::$app->request->post())) {
                ...
                $model->anggaran_pk_p = $model->anggaran_pk;
                ...
                if ($model->save()) {
                    ...
                    if (strpos($referrer, 'index-anggaran-pk-dev') !== false) {
                        $redirectUrl = \yii\helpers\Url::to([
            ...
            return $this->renderAjax('_formanggaranpk', [
                'model' => $model,
            ]);
        }

        return $this->render('update-anggaran-pk', [
            'model' => $model,
        ]);
    }

    public function actionUpdateAnggaranPkp($refindikatorsubkegiatan_id, $refperiode_id = null)
    {
        $model = $this->findModel($refindikatorsubkegiatan_id);
        ...
        if (Yii::$app->request->isAjax) {
            if ($model->load(Yii::$app->request->post())) {
                ...
                if ($model->save()) {
                    ...
                    if (strpos($referrer, 'index-anggaran-pkp-dev') !== false) {
                        $redirectUrl = \yii\helpers\Url::to([
            ...
            return $this->renderAjax('_formanggaranpkp', [
                'model' => $model,
            ]);
        }

        return $this->render('update-anggaran-pkp', [
            'model' => $model,
        ]);
    }
    ...
    /**
     * Deletes an existing SakipIndikatorcascadingsubkegiatan model.
     * If deletion is successful, the browser will be redirected to the 'index' page.
     * @param int $refindikatorsubkegiatan_id Refindikatorsubkegiatan ID
     * @return \yii\web\Response
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($refindikatorsubkegiatan_id)
    {
        $this->findModel($refindikatorsubkegiatan_id)->delete();

        return $this->redirect(['index']);
    }

    /**
     * Finds the SakipIndikatorcascadingsubkegiatan model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $refindikatorsubkegiatan_id Refindikatorsubkegiatan ID
     * @return SakipIndikatorcascadingsubkegiatan the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($refindikatorsubkegiatan_id)
    {
        if (($model = SakipIndikatorcascadingsubkegiatan::findOne(['refindikatorsubkegiatan_id' => $refindikatorsubkegiatan_id])) !== null) {
            return $model;
        }
