...
use frontend\models\search\SakipIndikatorsasaranrenstraTriwulanSearch;
 ...
 */
class SakipIndikatorsasaranrenstraTriwulanController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Displays a single SakipIndikatorsasaranrenstraTriwulan model.
     * @param int $refindikatorsasaranrenstratriwulan_id Refindikatorsasaranrenstratriwulan ID
     * @return string
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionView($refindikatorsasaranrenstratriwulan_id)
    {
        return $this->render('view', [
            'model' => $this->findModel($refindikatorsasaranrenstratriwulan_id),
        ]);
    }
    ...
    {
        $model = new SakipIndikatorsasaranrenstraTriwulan();

        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                return $this->redirect(['view', 'refindikatorsasaranrenstratriwulan_id' => $model->refindikatorsasaranrenstratriwulan_id]);
            }
        } else {
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($refindikatorsasaranrenstratriwulan_id)
    {
        $model = $this->findModel($refindikatorsasaranrenstratriwulan_id);
    ...
    public function actionUpdateTriwulanPk($refindikatorsasaranrenstratriwulan_id, $reftriwulan_id = null, $refperiode_id = null)
    {
        $model = $this->findModel($refindikatorsasaranrenstratriwulan_id);
    ...
    public function actionUpdateTriwulanPkp($refindikatorsasaranrenstratriwulan_id, $reftriwulan_id = null, $refperiode_id = null)
    {
        $model = $this->findModel($refindikatorsasaranrenstratriwulan_id);
    ...
    public function actionUpdateTriwulanCapaian($refindikatorsasaranrenstratriwulan_id, $reftriwulan_id = null, $refperiode_id = null)
    {
        $model = $this->findModel($refindikatorsasaranrenstratriwulan_id);
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($refindikatorsasaranrenstratriwulan_id)
    {
        $this->findModel($refindikatorsasaranrenstratriwulan_id)->delete();

        return $this->redirect(['index']);
    }

    /**
     * Finds the SakipIndikatorsasaranrenstraTriwulan model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $refindikatorsasaranrenstratriwulan_id Refindikatorsasaranrenstratriwulan ID
     * @return SakipIndikatorsasaranrenstraTriwulan the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($refindikatorsasaranrenstratriwulan_id)
    {
        if (($model = SakipIndikatorsasaranrenstraTriwulan::findOne(['refindikatorsasaranrenstratriwulan_id' => $refindikatorsasaranrenstratriwulan_id])) !== null) {
            return $model;
        }
