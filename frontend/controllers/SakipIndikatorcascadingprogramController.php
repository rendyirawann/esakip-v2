...
/**
 * SakipIndikatorcascadingprogramController implements the CRUD actions for SakipIndikatorcascadingprogram model.
 */
class SakipIndikatorcascadingprogramController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all SakipIndikatorcascadingprogram models.
     *
     * @return string
     */
    public function actionIndex($refperiode_id = null)
    {
        $searchModel = new SakipIndikatorcascadingprogramSearch();
        ...
        $query = SakipIndikatorcascadingprogram::find()->where(['refskpd_id' => $refskpd_id]);
    ...
    public function actionIndexAnggaranRkt($refperiode_id = null)
    {
        $searchModel = new SakipIndikatorcascadingprogramSearch();
        ...
        return $this->render('index-anggaran-rkt', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
            'nama_skpd' => $nama_skpd,
            'periodeList' => $periodeList,  // Kirim data periode ke view
    ...
    // public function actionIndexAnggaranRktDev($refperiode_id = null, $refskpd_id = null)
    // {
    //     $searchModel = new SakipIndikatorcascadingprogramSearch();
    //     $dataProvider = $searchModel->search($this->request->queryParams);
    //     $dataProvider->pagination = false;
    ...
    //     return $this->render('index-anggaran-rkt-dev', [
    //         'searchModel' => $searchModel,
    //         'dataProvider' => $dataProvider,
    //         'nama_skpd' => $nama_skpd,
    //         'periodeList' => $periodeList,  // Kirim data periode ke view
    ...
    public function actionIndexAnggaranRktDev($refperiode_id = null, $refskpd_id = null)
    {
        // Ganti 'SakipIndikatorcascadingprogramSearch' dengan SearchModel yang sesuai
        // =========================================================================
        // BLOK LOGIKA BARU UNTUK KEAMANAN SKPD
        // =========================================================================
        ...
        if ($refskpd_id) {
            $dataProvider->query->andWhere(['refskpd_id' => $refskpd_id]);
        }
        ...
        // Tambahkan juga filter periode ke DataProvider
        if ($refperiode_id) {
            $dataProvider->query->andWhere(['refperiode_id' => $refperiode_id]);
        }

        // --- GANTI BAGIAN INI DENGAN QUERY UTAMA ANDA ---
        // Ambil data utama berdasarkan $refskpd_id dan $refperiode_id yang sudah aman
        $data = [];
    ...
    public function actionIndexAnggaranPk($refperiode_id = null)
    {
        $searchModel = new SakipIndikatorcascadingprogramSearch();
        // If a refperiode_id is selected, add it to the query parameters
        if ($refperiode_id !== null) {
        ...
        return $this->render('index-anggaran-pk', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
            'nama_skpd' => $nama_skpd,
            'periodeList' => $periodeList,  // Kirim data periode ke view
    ...
    // public function actionIndexAnggaranPkDev($refperiode_id = null, $refskpd_id = null)
    // {
    //     $searchModel = new SakipIndikatorcascadingprogramSearch();
    //     $dataProvider = $searchModel->search($this->request->queryParams);
    //     $dataProvider->pagination = false;
    ...
    //     return $this->render('index-anggaran-pk-dev', [
    //         'searchModel' => $searchModel,
    //         'dataProvider' => $dataProvider,
    //         'nama_skpd' => $nama_skpd,
    //         'periodeList' => $periodeList,  // Kirim data periode ke view
    ...
    public function actionIndexAnggaranPkDev($refperiode_id = null, $refskpd_id = null)
    {
        ...
        // Tambahkan filter refskpd_id secara paksa ke query milik DataProvider
        if ($refskpd_id) {
            $dataProvider->query->andWhere(['refskpd_id' => $refskpd_id]);
        }
        // --- AKHIR
    ...
    public function actionIndexAnggaranPkp($refperiode_id = null)
    {
        $searchModel = new SakipIndikatorcascadingprogramSearch();
        // If a refperiode_id is selected, add it to the query parameters
        if ($refperiode_id !== null) {
        ...
        return $this->render('index-anggaran-pkp', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
            'nama_skpd' => $nama_skpd,
            'periodeList' => $periodeList,  // Kirim data periode ke view
    ...
    // public function actionIndexAnggaranPkpDev($refperiode_id = null, $refskpd_id = null)
    // {
    //     $searchModel = new SakipIndikatorcascadingprogramSearch();
    //     $dataProvider = $searchModel->search($this->request->queryParams);
    //     $dataProvider->pagination = false;
    ...
    //     return $this->render('index-anggaran-pkp-dev', [
    //         'searchModel' => $searchModel,
    //         'dataProvider' => $dataProvider,
    //         'nama_skpd' => $nama_skpd,
    //         'periodeList' => $periodeList,  // Kirim data periode ke view
    ...
    /**
     * Displays a single SakipIndikatorcascadingprogram model.
     * @param int $refindikatorprogram_id Refindikatorprogram ID
     * @return string
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionView($refindikatorprogram_id)
    {
        return $this->render('view', [
            'model' => $this->findModel($refindikatorprogram_id),
        ]);
    }

    /**
     * Creates a new SakipIndikatorcascadingprogram model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new SakipIndikatorcascadingprogram();

        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                return $this->redirect(['view', 'refindikatorprogram_id' => $model->refindikatorprogram_id]);
            }
        } else {
    ...
    /**
     * Updates an existing SakipIndikatorcascadingprogram model.
     * If update is successful, the browser will be redirected to the 'view' page.
     * @param int $refindikatorprogram_id Refindikatorprogram ID
     * @return string|\yii\web\Response
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($refindikatorprogram_id, $refperiode_id = null)
    {
        $model = $this->findModel($refindikatorprogram_id);
                ...
                if ($model->save()) {
                    ...
                    for ($i = 1; $i <= 4; $i++) {
                        ...
                        $triwulanModel = SakipIndikatorcascadingprogramTriwulan::findOne([
                            'refindikatorprogram_id' => $model->refindikatorprogram_id,
                            'reftriwulan_id' => $i
                        ]);

                        if ($triwulanModel !== null) {
                            // Set nilai triwulan_target_rkt sesuai dengan target_rkt yang baru
                            $triwulanModel->triwulan_target_rkt = $model->target_rkt;
                    ...
                    if (strpos($referrer, 'index-rkt-dev') !== false) {
                        $redirectUrl = \yii\helpers\Url::to(['sakip-indikatorcascadingprogram/index-rkt-dev', 'refperiode_id' => $model->refperiode_id, 'refskpd_id' => $model->refskpd_id]);
                    }
    ...
    public function actionUpdateTargetPk($refindikatorprogram_id, $refperiode_id = null)
    {
        $model = $this->findModel($refindikatorprogram_id);
        ...
        if (Yii::$app->request->isAjax) {
            if ($model->load(Yii::$app->request->post())) {
                ...
                $model->target_pk_p = str_replace(',', '.', $model->target_pk);

                $model->target_pk_p = $model->target_pk;
                ...
                if ($model->save()) {
                    ...
                    if (strpos($referrer, 'index-tahunan-pk-dev') !== false) {
                        $redirectUrl = \yii\helpers\Url::to(['sakip-indikatorcascadingprogram/index-tahunan-pk-dev', 'refperiode_id' => $model->refperiode_id, 'refskpd_id' => $model->refskpd_id]);
                    }
                    return $this->asJson(['success' => true, 'redirect' => $redirectUrl]);
                } else {
                    // Log error jika model utama gagal disimpan
    ...
    public function actionUpdateTargetPkp($refindikatorprogram_id, $refperiode_id = null)
    {
        $model = $this->findModel($refindikatorprogram_id);
    ...
    public function actionUpdateTargetCapaian($refindikatorprogram_id, $refperiode_id = null)
    {
        $model = $this->findModel($refindikatorprogram_id);
    ...
    /**
     * Deletes an existing SakipIndikatorcascadingprogram model.
     * If deletion is successful, the browser will be redirected to the 'index' page.
     * @param int $refindikatorprogram_id Refindikatorprogram ID
     * @return \yii\web\Response
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($refindikatorprogram_id)
    {
        $this->findModel($refindikatorprogram_id)->delete();

        return $this->redirect(['index']);
    }

    /**
     * Finds the SakipIndikatorcascadingprogram model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $refindikatorprogram_id Refindikatorprogram ID
     * @return SakipIndikatorcascadingprogram the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($refindikatorprogram_id)
    {
        if (($model = SakipIndikatorcascadingprogram::findOne(['refindikatorprogram_id' => $refindikatorprogram_id])) !== null) {
            return $model;
        }
