...
<div class="sakip-indikatorsasaranrenstra-form">
    ...
    <?= $form->field($model, 'uraian_indikatorsasaranrenstra')->textarea(['rows' => 6]) ?>
    ...
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($model, 'indikatorsasaranrenstra_satuan')->textInput(['maxlength' => true]) ?>
        </div>
        <div class="col-sm-6">
            <?= $form->field($model, 'indikatorsasaranrenstra_target')->textInput(['maxlength' => true]) ?>
        </div>
    </div>
    ...
    <?= $form->field($model, 'indikatorsasaranrenstra_isaktif')->radioList(
    ...
    )->label('Status Indikator Sasaran Renstra') ?>
