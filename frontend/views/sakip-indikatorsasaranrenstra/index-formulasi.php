                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Formulasi Sasaran Renstra</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Formulasi Sasaran Renstra</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td rowspan="4">
                                                        <?= Html::button('<i class="fas fa-edit"></i>', [
                                                            ...
                                                            'data-url' => Url::to(['update-formulasi', 'refindikatorsasaranrenstra_id' => $indikator->refindikatorsasaranrenstra_id])
                                                        ]) ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th colspan="2">Alasan</th>
                                                    <td colspan="3" style="white-space: normal;"><?= $indikator->alasan_sasaranrenstra ?></td>
                                                </tr>
                                                <tr>
                                                    <th colspan="2">Cara Pengukuran</th>
                                                    <td colspan="3" style="white-space: normal;"><?= $indikator->formulasi_sasaranrenstra ?></td>
                                                </tr>
                                                <tr>
                                                    <th colspan="2">Kriteria</th>
                                                    <td colspan="3" style="white-space: normal;"><?= $indikator->kriteria_sasaranrenstra ?></td>
                                                </tr>
                                            <?php endforeach;
                        ...
                        <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content" style="border-radius: 20px;">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="updateModalLabel">Update Data SAKIP Formulasi Sasaran Renstra</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <!-- The form will be loaded here -->
