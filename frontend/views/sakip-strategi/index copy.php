        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Periode Strategi Renstra - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i> Data SAKIP Strategi Sasaran Renstra - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?> (Periode <?= $selectedPeriodValue ?>)
                        </h6>
                    </div>
                    <div class="card-body">
                                                                        ...
                                                                        <tbody>
                                                                            <?php if (!empty($sasaranRenstra->strategiRenstra)): ?>
                                                                                <?php foreach ($sasaranRenstra->strategiRenstra as $strategiRenstra): ?>
                                                                                    <tr>
                                                                                        <td style="white-space: normal;"><?= Html::decode($strategiRenstra->uraian_strategi) ?></td>
                                                                                        <td class="text-center">
                                                                                            <?= Html::button('<i class="fas fa-edit"></i>', [
                                                                                                ...
                                                                                                'data-url' => Url::to(['update', 'refstrategi_id' => $strategiRenstra->refstrategi_id])
                                                                                            ]) ?>
                                                                                            <?= Html::a('<i class="fas fa-trash-alt"></i>', ['delete', 'refstrategi_id' => $strategiRenstra->refstrategi_id], [
                                                                            ...
                                                                            <?php else: ?>
                                                                                <tr>
                                                                                    <td colspan="2" class="text-center"><b><i>Belum ada strategi.</i></b></td>
                                                                                </tr>
                                                                            <?php endif; ?>
                                                                        </tbody>
                                                                    </table>
