...
/** @var frontend\models\search\SakipStrategiSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'e-Sakip - Data Strategi';
...
$this->registerJs("
    $('#createModal').on('show.bs.modal', function (event) {
        ...
        var modal = $(this);
        $.ajax({
            url: '" . Url::to(['sakip-strategi/create']) . "',
            type: 'GET',
            data: {
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Strategi Renstra</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Strategi Renstra</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Periode Strategi Renstra - <?= Html::decode(ucwords(strtolower($nama_skpd))) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i> Data SAKIP Strategi Sasaran Renstra - <?= Html::decode(ucwords(strtolower($nama_skpd))) ?> (Periode <?= $selectedPeriodValue ?>)
                        </h6>
                    </div>
                    <div class="card-body">
                                                        ...
                                                        <?php foreach ($misi['tujuans'] as $tujuanId => $tujuan): ?>
                                                            <div class="tujuan-block mb-4">
                                                                ...
                                                                <?php foreach ($tujuan['sasarans'] as $sasaran): ?>
                                                                    <div class="list-group-item list-group-item-light p-3 mb-3 rounded">
                                                                        <div class="d-flex w-100 justify-content-between">
                                                                            <h6 class="mb-1 fw-bold">
                                                                                <i class="fas fa-rocket me-2"></i>Sasaran: <?= Html::decode($sasaran->uraian_sasaranrenstra) ?>
                                                                            </h6>
                                                                            <?= Html::button('<i class="fas fa-plus"></i> Tambah Strategi', [
                                                                                'class' => 'btn btn-primary',
                                                                                'data-refsasaranrenstra' => $sasaran->refsasaranrenstra_id,
                                                                                'data-refperiode' => $sasaran->refperiode_id,
                                                                        ...
                                                                        <ul class="list-unstyled ps-3">
                                                                            <?php if (empty($sasaran->strategiRenstra)): ?>
                                                                                <li class="font-italic text-muted">Belum ada Strategi.</li>
                                                                            <?php else: ?>
                                                                                <?php foreach ($sasaran->strategiRenstra as $strategi): ?>
                                                                                    <li class="d-flex justify-content-between align-items-center py-1">
                                                                                        <span><i class="fas fa-caret-right me-2 text-muted"></i><?= Html::decode($strategi->uraian_strategi) ?></span>
                                                                                        <div class="btn-group" role="group">
                                                                                            <?= Html::button('<i class="fas fa-edit"></i>', [
                                                                                                ...
                                                                                                'data-url' => Url::to(['update', 'refstrategi_id' => $strategi->refstrategi_id])
                                                                                            ]) ?>
                                                                                            <?= Html::a('<i class="fas fa-trash-alt"></i>', ['delete', 'refstrategi_id' => $strategi->refstrategi_id], [
