...
$this->title = 'e-SAKIP - PK Triwulan Indikator Sasaran Renstra';
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">PK Triwulan Indikator Sasaran Renstra</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">PK Triwulan Indikator Sasaran Renstra</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="card>
                    <div class=" card-header" style="background-color: #04A9F5; padding: 8px;">
                    <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                        <i class="fas fa-pen-fancy"></i>Data PK Triwulan Indikator Sasaran Renstra - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?> (Periode <?= $selectedPeriodValue ?>)
                    </h6>
                </div>
                <div class="card-body">
                    <!-- Flash messages -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php else: ?>
                            <div class="dt-responsive table-responsive" style="padding-right:20px;" id="refresh">
                                <?php
                                ...
                                ?>
                                        <table class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $indikator->refIndikatorsasaranrenstra->target_pk ?></td>
                                                <td><?= $indikator->triwulan_target_pk ?></td>
                                                <td style="white-space:normal;"><?= $indikator->triwulan_keterangan ?></td>
                                                <td>
                                                    <?php if (!empty($indikator->refIndikatorsasaranrenstra->target_pk)): ?>
            ...
            <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content" style="border-radius: 20px;">
                        <div class="modal-header">
                            <h5 class="modal-title" id="updateModalLabel">Update Data PK Triwulan Indikator Sasaran Renstra</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <!-- The form will be loaded here -->
