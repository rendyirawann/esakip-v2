                ...
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <?php else: ?>
                                <div class="dt-responsive table-responsive" style="padding-right:20px;">
                                    <?php
                                                     ...
                                                     <?php if ($isAdmin): ?>
                                                         <td>
                                                             <?= Html::button('<i class="fas fa-edit"></i>', [
                                                                 'class' => 'btn btn-success btn-sm btn-edit-triwulanpk',
                                                                 'title' => 'Update',
                                                                 'data-bs-toggle' => 'modal',
                                                                 'data-bs-target' => '#updateModal',
                                                                 'data-url' => Url::to(['update-triwulan-pk', 'refindikatorsasaranrenstratriwulan_id' => $indikator->refindikatorsasaranrenstratriwulan_id, 'reftriwulan_id' => $indikator->reftriwulan_id])
                                                             ]) ?>
                                                         </td>
                                                     <?php endif; ?>
