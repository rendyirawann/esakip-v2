...
<div class="sakip-stretegi-form">
    ...
    <!-- Input untuk menampilkan uraian_strategi -->
    <div class="form-group">
        <label for="uraian_strategi">Uraian Strategi</label>
        <input type="text" id="uraian_strategi" class="form-control"
            value="<?= Html::decode($model->strategiRenstra ? $model->strategiRenstra->uraian_strategi : 'Uraian Strategi tidak ditemukan') ?>"
            disabled>
    </div>
    ...
    <!-- Input untuk menampilkan uraian_sasaranrenstra -->
    <div class="form-group">
        <label for="uraian_sasaranrenstra">Uraian Sasaran Renstra</label>
        <input type="text" id="uraian_sasaranrenstra" class="form-control"
            value="<?= Html::decode($model->sasaranRenstra ? $model->sasaranRenstra->uraian_sasaranrenstra : 'Uraian Sasaran Renstra tidak ditemukan') ?>"
            disabled>
    </div>
    ...
    <!-- Input untuk menampilkan uraian_sasaran -->
    <div class="form-group">
        <label for="uraian_sasaran">Uraian Sasaran</label>
        <input type="text" id="uraian_sasaran" class="form-control"
            value="<?= Html::decode($model->sasaran ? $model->sasaran->uraian_sasaran : 'Uraian Sasaran tidak ditemukan') ?>"
            disabled>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" id="refmisi_id" class="form-control" value="<?= Html::decode($model->misi ? $model->misi->uraian_misi : 'Misi tidak ditemukan') ?>" disabled>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" id="reftujuan_id" class="form-control" value="<?= Html::decode($model->tujuan ? $model->tujuan->uraian_tujuan : 'Tujuan tidak ditemukan') ?>" disabled>
    </div>
