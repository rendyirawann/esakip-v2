...
/** @var frontend\models\search\SakipKebijakanSearch $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="sakip-kebijakan-search">
    ...
    <?= $form->field($model, 'refkebijakan_id') ?>

    <?= $form->field($model, 'uraian_kebijakan') ?>

    <?= $form->field($model, 'refskpd_id') ?>

    <?= $form->field($model, 'refstrategi_id') ?>

    <?= $form->field($model, 'refmisi_id') ?>

    <?php // echo $form->field($model, 'refsasaranrenstra_id') ?>

    <?php // echo $form->field($model, 'refsasaran_id') ?>
