        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Periode Kebijakan Renstra - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i> Data SAKIP Kebijakan Renstra - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?> (Periode <?= $selectedPeriodValue ?>)
                        </h6>
                    </div>
                                                    ...
                                                    <div class="card-body p-2">
                                                        ...
                                                        <div class="card mb-2 border-0">
                                                            <div class="card-header bg-success text-white p-2 d-flex justify-content-between align-items-center">
                                                                <h6 class="mb-0" style="cursor: pointer;" data-bs-toggle="collapse" data-bs-target="#strategiCollapse">
                                                                    (Sasaran Renstra) <?= Html::decode($sasaranRenstra->uraian_sasaranrenstra) ?>
                                                                </h6>
                                                                <i class="fas fa-chevron-down"></i>
                                                            </div>
                                                            <div id="strategiCollapse" class="collapse show">
                                                                <div class="card-body p-2">
                                                                    <?php
                                                                    ...
                                                                    <?php if (!empty($strategiRenstra)): ?>
                                                                        <?php foreach ($strategiRenstra as $strategi): ?>
                                                                            <!-- STRATEGI RENSTRA -->
                                                                            <div class="card mb-2 border-0">
                                                                                <div class="card-header bg-primary text-white p-2 d-flex justify-content-between align-items-center">
                                                                                    <h6 class="mb-0" style="cursor: pointer;" data-bs-toggle="collapse" data-bs-target="#kebijakanUntukStrategiCollapse">
                                                                                        (Strategi Renstra) <br> <?= Html::decode($strategi->uraian_strategi) ?>
                                                                                    </h6>
                                                                                    <i class="fas fa-chevron-down"></i>
                                                                                </div>
                                                                                <div id="kebijakanUntukStrategiCollapse" class="collapse show">
                                                                                    <div class="card-body p-2">
                                                                                        <!-- KEBIJAKAN UNTUK STRATEGI RENSTRA -->
                                                                                        <div class="card mb-2 border-0">
                                                                                            <div class="card-header bg-warning text-white p-2 d-flex justify-content-between align-items-center">
                                                                                                <h6 class="mb-0" style="cursor: pointer;" data-bs-toggle="collapse" data-bs-target="#kebijakanCollapse">
                                                                                                    Kebijakan untuk Strategi: <br> <?= Html::decode($strategi->uraian_strategi) ?>
                                                                                                </h6>
                                                                                                <i class="fas fa-chevron-down"></i>
                                                                                            </div>
                                                                                            <div id="kebijakanCollapse" class="collapse show">
                                                                                                <div class="card-body p-2">
                                                                                                    <!-- TABLE KEBIJAKAN STRATEGI RENSTRA -->
                                                                                                    <table class="table table-bordered table-hover table-sm">
                                                                                                        <thead class="table-light">
                                                                                                            <tr>
                                                                                                                <th>Kebijakan Strategi Renstra</th>
                                                                                                                <?php if ($isAdmin): ?>
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            ...
                                                                                                            <?php if (!empty($kebijakans)): ?>
                                                                                                                <?php foreach ($kebijakans as $kebijakan): ?>
                                                                                                                    <tr>
                                                                                                                        <td style="white-space: normal;"><?= Html::decode($kebijakan->uraian_kebijakan) ?></td>
                                                                                                                        <?php if ($isAdmin): ?>
                                                                                                            ...
                                                                                                            <?php else: ?>
                                                                                                                <tr>
                                                                                                                    <td colspan="<?= $isAdmin ? 2 : 1 ?>"><b><i>Kebijakan belum ada.</i></b></td>
                                                                                                                </tr>
                                                                                                            <?php endif; ?>
                                                                                                        </tbody>
                                                                                                    </table>
