...
/** @var backend\models\SimonaMediacascadingkegiatanOpd$model */
...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#datasimonamediacascadingkegiatanopd').off('submit').on('submit', function(e) {
...
<div class="data-simona-mediacascadingkegiatan-form">

    <?php $form = ActiveForm::begin([
        'id' => 'datasimonamediacascadingkegiatanopd',
        'action' => ['simona-mediacascadingkegiatan-opd/create'],
        'options' => ['enctype' => 'multipart/form-data']
    ]); ?>

    <?= $form->field($model, 'refsimonacascadingkegiatan_id')->hiddenInput(['id' => 'simona-mediacascadingkegiatan-opd-refsimonacascadingkegiatanopd_id'])->label(false) ?>

    <?= $form->field($model, 'file_docs[]')->fileInput(['multiple' => true]) ?> <!-- Multiple file input -->

    <?= $form->field($model, 'nama_file')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'refuser_id')->hiddenInput(['value' => Yii::$app->user->id])->label(false) ?>

    <?= $form->field($model, 'refskpd_id')->textInput(['value' => Yii::$app->user->identity->refskpd_id])->label(false) ?>
