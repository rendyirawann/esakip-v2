...
/** @var backend\models\SakipPenjabatskpdCascadingkegiatan$model */
...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#datapenjabatskpdcascadingkegiatan').off('submit').on('submit', function(e) {
...
$this->registerJs("
    $('#refpenjabatskpd_id').on('change', function() {
        ...
        if (refpenjabatskpd_id) {
            $.ajax({
                url: '" . Url::to(['sakip-penjabatskpd-cascadingkegiatan/fetch-eselon']) . "',
                type: 'GET',
...
<div class="data-penjabatskpd-cascadingkegiatan-form">

    <?php
    $form = ActiveForm::begin([
        'id' => 'datapenjabatskpdcascadingkegiatan',
    ...
    <!-- Assuming your modal form includes a hidden input for refindikatorkegiatan_id -->
    <?= $form->field($model, 'refindikatorkegiatan_id')->hiddenInput(['id' => 'refindikatorkegiatan_id'])->label(false) ?>

    <div class="form-group">
        <label for="refindikatorkegiatan_id">Refindikatorkegiatan</label>
        <input type="text" id="refindikatorkegiatan_id" class="form-control" value="<?= $model->refindikatorkegiatan_id ?>" readonly>
    </div>
    ...
    <div class="form-group">
        <label for="uraian_sasarankegiatan">Uraian Sasaran Kegiatan</label>
        <input type="text" id="uraian_sasarankegiatan" class="form-control" value="<?= $model->uraian_sasarankegiatan ?>" readonly>
    </div>

    <?= $form->field($model, 'uraian_indikatorkegiatan')->hiddenInput()->label(false) ?>

    <div class="form-group">
        <label for="uraian_indikatorkegiatan">Uraian Indikator Kegiatan</label>
        <input type="text" id="uraian_indikatorkegiatan" class="form-control" value="<?= $model->uraian_indikatorkegiatan ?>" readonly>
    </div>

    <?= $form->field($model, 'kegiatan_target')->hiddenInput()->label(false) ?>

    <div class="form-group">
        <label for="kegiatan_target">Kegiatan Target</label>
        <input type="text" id="kegiatan_target" class="form-control" value="<?= $model->kegiatan_target ?>" readonly>
    </div>

    <?= $form->field($model, 'kegiatan_satuan')->hiddenInput()->label(false) ?>

    <div class="form-group">
        <label for="kegiatan_satuan">Kegiatan Satuan</label>
        <input type="text" id="kegiatan_satuan" class="form-control" value="<?= $model->kegiatan_satuan ?>" readonly>
    </div>
