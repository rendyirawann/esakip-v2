            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success) {
                        ...
                        $('#refvisi_p_id').val(data.uraian_visi);
                    } else {
...
<div class="sakip-sasaranrenstra-form">
    ...
    <div id="additional-fields" style="display:none;">
        ...
        <?= $form->field($model, 'refsasaran_p_id')->dropDownList([], ['prompt' => 'Pilih Sasaran Perubahan', 'id' => 'sakip-sasaranrenstra-refsasaran_p_id'])->label('Pilih Sasaran Perubahan') ?>
        ...
        <?= $form->field($model, 'sasaranrenstra_p_isaktif')->hiddenInput(['value' => 'T'])->label(false) ?>
