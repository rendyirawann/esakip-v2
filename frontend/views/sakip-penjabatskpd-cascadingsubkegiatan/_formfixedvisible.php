...
<div class="data-penjabatskpd-cascadingsubkegiatan-form">
    ...
    <div class="form-group">
        <label for="refcascadingsubkegiatan_id">Refcascadinsubkegiatan</label>
    ...
    <div class="form-group">
        <label for="refindikatorsubkegiatan_id">Refindikatorsubkegiatan</label>
        <input type="text" id="refindikatorsubkegiatan_id" class="form-control" value="<?= $model->refindikatorsubkegiatan_id ?>" readonly>
    </div>
    ...
    <div class="form-group">
        <label for="uraian_sasaransubkegiatan">Uraian Sasaran Sub Kegiatan</label>
    ...
    <div class="form-group">
        <label for="uraian_indikatorsubkegiatan">Uraian Indikator Sub Kegiatan</label>
    ...
    <div class="form-group">
        <label for="subkegiatan_target">Sub Kegiatan Target</label>
