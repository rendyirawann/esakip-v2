...
<div class="sakip-indikatorsasaranrenstra-form">
    ...
    <?= $form->field($model, 'uraian_indikatorsasaranrenstra_p')->textarea(['rows' => 2])->label('Uraian Indikator Sasaran Renstra')  ?>
    ...
    <!-- refsasaranrenstra_p_id: Uraian Sasaran Renstra -->
    <?= $form->field($model, 'refsasaranrenstra_p_id')->hiddenInput()->label(false) ?>

    <div class="form-group">
        <label for="refsasaranrenstra_p_id">Uraian Sasaran Renstra</label>
        <input type="text" id="refsasaranrenstra_p_id" class="form-control" value="<?= $model->refSasaranrenstra->uraian_sasaranrenstra_p ?>" readonly>
    </div>
    <div class="row">
        <div class="col-sm-6">
    ...
    <?= $form->field($model, 'indikatorsasaranrenstra_p_isaktif')->hiddenInput(['value' => 'T'])->label(false) ?>
