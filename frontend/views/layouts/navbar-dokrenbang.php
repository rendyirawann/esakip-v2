...
// Grup route untuk "Dokumen"
$dokumenRoutes = [
  'dokrenbang-dokumen-keluar-kegiatan/index',
];
$isDokumenActive = in_array($currentRoute, $dokumenRoutes);

// Grup route untuk submenu "Dokumen Keluar"
$dokumenKeluarRoutes = [
  'dokrenbang-dokumen-keluar-kegiatan/index',
];
$isDokumenKeluarActive = in_array($currentRoute, $dokumenKeluarRoutes);
  ...
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="<?= Url::to(['/site/index']) ?>" class="b-brand text-primary">
        ...
        <h5><img src="<?= Url::base(true) ?>/lightapp/assets/images/bappeda.png" alt="logo image" height="60" width="60" class="logo-lg" />DOKRENBANG<span class="badge bg-brand-color-2 rounded-pill ms-2 theme-version">v2.0</span></h5>
    ...
    <div class="navbar-content">
      <ul class="pc-navbar">
        ...
        <li class="pc-item pc-hasmenu <?= $currentRoute == 'site/index-dokrenbang' ? 'active' : '' ?>">
          <a href="<?= Url::to(['/site/index-dokrenbang']) ?>" class="pc-link">
            <span class="pc-micon">
        ...
        <li class="pc-item pc-hasmenu <?= $isDokumenActive ? 'active show' : '' ?>">
          <a href="#!" class="pc-link <?= $isDokumenActive ? 'active' : '' ?>">
            <span class="pc-micon">
              <i class="ph-duotone ph-file-text"></i>
            </span>
            <span class="pc-mtext">Dokumen</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
          <ul class="pc-submenu <?= $isDokumenActive ? 'show' : '' ?>">
            <li class="pc-item pc-hasmenu <?= $isDokumenKeluarActive ? 'active show' : '' ?>">
              <a class="pc-link <?= $isDokumenKeluarActive ? 'active' : '' ?>" href="#">Dokumen Keluar<span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
              <ul class="pc-submenu <?= $isDokumenKeluarActive ? 'show' : '' ?>">
                <li class="pc-item <?= $currentRoute == 'dokrenbang-dokumen-keluar-kegiatan/index' ? 'active' : '' ?>"><a class="pc-link" href="<?= Url::to(['/dokrenbang-dokumen-keluar-kegiatan/index']) ?>">Dokumen Kegiatan</a></li>
              </ul>
            </li>
          </ul>
        </li>
