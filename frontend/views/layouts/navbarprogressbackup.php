            ...
            <div class="progress-section position-relative">
              <div class="esakip-detail-card">
                ...
                <ul>
                  ...
                  <li>Indikator Sasaran: <?= $countIndikatorSasaran > 0 ? 'Completed' : 'Pending' ?></li>
                  <li>Tujuan: <?= $countTujuan > 0 ? 'Completed' : 'Pending' ?></li>
                  <li>Indikator Tujuan: <?= $countIndikatorTujuan > 0 ? 'Completed' : 'Pending' ?></li>
                  <li>Program: <?= $countIndikatorCascadingProgram > 0 ? 'Completed' : 'Pending' ?></li>
                  <li>Kegiatan: <?= $countIndikatorCascadingKegiatan > 0 ? 'Completed' : 'Pending' ?></li>
                  <li>Sub Kegiatan: <?= $countIndikatorCascadingSubkegiatan > 0 ? 'Completed' : 'Pending' ?></li>
                </ul>
              </div>
            </div>
