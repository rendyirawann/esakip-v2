...
// Grup route untuk "Perencanaan"
$perencanaanRoutes = [
  'simona-perencanaan/index',
  'simona-perencanaan/index-pegawai',
  'simona-perencanaan/kalender-perencanaan'
];
$isPerencanaanActive = in_array($currentRoute, $perencanaanRoutes);

// Grup route untuk submenu "Perencanaan"
$perencanaanSubRoutes = [
  'simona-perencanaan/index',
  'simona-perencanaan/index-pegawai',
  'simona-perencanaan/kalender-perencanaan'
];
$isPerencanaanSubActive = in_array($currentRoute, $perencanaanSubRoutes);
  ...
  <div class="navbar-wrapper">
    ...
    <div class="navbar-content">
      <ul class="pc-navbar">
        ...
        <li class="pc-item pc-hasmenu <?= $currentRoute == 'site/index-simona' ? 'active' : '' ?>">
          <a href="<?= Url::to(['/site/index-simona']) ?>" class="pc-link">
            <span class="pc-micon">
        ...
        <li class="pc-item pc-hasmenu <?= $isPerencanaanActive ? 'active show' : '' ?>">
          <a href="#!" class="pc-link <?= $isPerencanaanActive ? 'active' : '' ?>">
            <span class="pc-micon">
              <i class="ph-duotone ph-file-text"></i>
            </span>
            <span class="pc-mtext">Perencanaan</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
          <ul class="pc-submenu <?= $isPerencanaanActive ? 'show' : '' ?>">
            <li class="pc-item pc-hasmenu <?= $isPerencanaanSubActive ? 'active show' : '' ?>">
              <a class="pc-link <?= $isPerencanaanSubActive ? 'active' : '' ?>" href="#">Perencanaan<span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
              <ul class="pc-submenu <?= $isPerencanaanSubActive ? 'show' : '' ?>">
                <?php
                $assignments = Yii::$app->authManager->getAssignments(Yii::$app->user->getId());
                if (isset($assignments['pegawai'])) {
                ?>
                  <li class="pc-item <?= $currentRoute == 'simona-perencanaan/index-pegawai' ? 'active' : '' ?>"><a class="pc-link" href="<?= Url::to(['/simona-perencanaan/index-pegawai']) ?>">Data Perencanaan Program/Kegiatan</a></li>
                <?php } elseif (isset($assignments['skpd'])) { ?>
                  <li class="pc-item <?= $currentRoute == 'simona-perencanaan/index' ? 'active' : '' ?>"><a class="pc-link" href="<?= Url::to(['/simona-perencanaan/index']) ?>">Data Perencanaan Program/Kegiatan</a></li>
                <?php } ?>
                <li class="pc-item <?= $currentRoute == 'simona-perencanaan/kalender-perencanaan' ? 'active' : '' ?>"><a class="pc-link" href="<?= Url::to(['/simona-perencanaan/kalender-perencanaan']) ?>">Kalender Perencanaan</a></li>
              </ul>
            </li>
          </ul>
        </li>
        ...
        ?>
          ...
          <li class="pc-item pc-hasmenu <?= $isPengaturanActive ? 'active show' : '' ?>">
            ...
            <ul class="pc-submenu <?= $isPengaturanActive ? 'show' : '' ?>">
              <li class="pc-item <?= $currentRoute == 'instansi/index' ? 'active' : '' ?>"><a class="pc-link" href="<?= Url::to(['/instansi/index']) ?>">Instansi</a></li>
