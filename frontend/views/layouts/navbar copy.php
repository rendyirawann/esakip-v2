...
$countSasaran = \frontend\models\SakipSasaranrenstra::find()->where(['refskpd_id' => $refskpd_id])->count();
$countIndikatorSasaran = \frontend\models\SakipIndikatorsasaranrenstra::find()->where(['refskpd_id' => $refskpd_id])->count();
$countTujuan = \frontend\models\SakipTujuanrenstra::find()->where(['refskpd_id' => $refskpd_id])->count();
$countIndikatorTujuan = \frontend\models\SakipIndikatortujuanrenstra::find()->where(['refskpd_id' => $refskpd_id])->count();
$countStrategi = \frontend\models\SakipStrategi::find()->where(['refskpd_id' => $refskpd_id])->count();
$countKebijakan = \frontend\models\SakipKebijakan::find()->where(['refskpd_id' => $refskpd_id])->count();
$countCascadingProgram = \frontend\models\SakipCascadingprogram::find()->where(['refskpd_id' => $refskpd_id])->count();
$countCascadingKegiatan = \frontend\models\SakipCascadingkegiatan::find()->where(['refskpd_id' => $refskpd_id])->count();
$countCascadingSubkegiatan = \frontend\models\SakipCascadingsubkegiatan::find()->where(['refskpd_id' => $refskpd_id])->count();
$countIndikatorCascadingProgram = \frontend\models\SakipIndikatorcascadingprogram::find()->where(['refskpd_id' => $refskpd_id])->count();
$countIndikatorCascadingKegiatan = \frontend\models\SakipIndikatorcascadingkegiatan::find()->where(['refskpd_id' => $refskpd_id])->count();
$countIndikatorCascadingSubkegiatan = \frontend\models\SakipIndikatorcascadingsubkegiatan::find()->where(['refskpd_id' => $refskpd_id])->count();
$countIndikatorSasaranTriwulan = \frontend\models\SakipIndikatorsasaranrenstraTriwulan::find()->where(['refskpd_id' => $refskpd_id])->count();
$countIndikatorCascadingProgramTriwulan = \frontend\models\SakipIndikatorcascadingprogramTriwulan::find()->where(['refskpd_id' => $refskpd_id])->count();
$countIndikatorCascadingKegiatanTriwulan = \frontend\models\SakipIndikatorcascadingkegiatanTriwulan::find()->where(['refskpd_id' => $refskpd_id])->count();
$countIndikatorCascadingSubkegiatanTriwulan = \frontend\models\SakipIndikatorcascadingsubkegiatanTriwulan::find()->where(['refskpd_id' => $refskpd_id])->count();
  ...
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="<?= Url::to(['/site/index']) ?>" class="b-brand text-primary">
        ...
        <h5><img src="<?= Url::base(true) ?>/lightapp/assets/images/bappeda.png" alt="logo image" height="60" width="60" class="logo-lg" />eSakip<span class="badge bg-brand-color-2 rounded-pill ms-2 theme-version">v1.0</span></h5>
          ...
          <ul class="pc-submenu">
            ...
            <li class="pc-item pc-hasmenu">
              ...
              <ul class="pc-submenu">
                ...
                <li class="pc-item"><a class="pc-link" href="<?= Url::to(['/sakip-sasaranrenstra/index-formulasi']) ?>">Formulasi Renstra</a></li>
              </ul>
            </li>
