    ...
    <div class="navbar-content">
      <ul class="pc-navbar">
        ...
        <li class="pc-item pc-hasmenu">
          <a href="#!" class="pc-link">
            ...
            <span class="pc-mtext">RENJA</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
          <ul class="pc-submenu">
            <li class="pc-item"><a class="pc-link" href="<?= Url::to(['/laporan-renja-kata-pengantar/index']) ?>">Kata Pengantar</a></li>
            <li class="pc-item pc-hasmenu">
              <a class="pc-link" href="#">Daftar Laporan<span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
              <ul class="pc-submenu">
                <li class="pc-item"><a class="pc-link" href="<?= Url::to(['/sakip-sasaranrenstra/index']) ?>">Daftar Isi</a></li>
                <li class="pc-item"><a class="pc-link" href="<?= Url::to(['/sakip-tujuanrenstra/index']) ?>">Daftar Table</a></li>
                <li class="pc-item"><a class="pc-link" href="<?= Url::to(['/sakip-indikatortujuanrenstra/index']) ?>">Daftar Gambar</a></li>
      ...
      <div class="card nav-action-card bg-brand-color-4">
        <div class="card-body" style="background-image: url('<?= Url::base(true) ?>/lightapp/assets/images/layout/nav-card-bg.svg')">
          ...
          <a href="<?= Url::to(['/site/index-esakip']) ?>" class="btn btn-danger" data-method="post">Go Back to eSakip</a>
        </div>
      </div>
    </div>
