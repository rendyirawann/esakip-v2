...
/** @var backend\models\SakipPenjabatskpdCascadingprogram $model */
...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#datapenjabatskpdcascadingprogram').off('submit').on('submit', function(e) {
...
$this->registerJs("
    $('#refpenjabatskpd_id').on('change', function() {
        ...
        if (refpenjabatskpd_id) {
            $.ajax({
                url: '" . Url::to(['sakip-penjabatskpd-cascadingprogram/fetch-eselon']) . "',
                type: 'GET',
...
<div class="data-penjabatskpd-cascadingprogram-form">

    <?php
    $form = ActiveForm::begin([
        'id' => 'datapenjabatskpdcascadingprogram',
    ...
    <div class="form-group">
        <label for="refeselon_label">Refeselon</label>
    ...
    <!-- Assuming your modal form includes a hidden input for refindikatorprogram_id -->
    <?= $form->field($model, 'refindikatorprogram_id')->hiddenInput(['id' => 'refindikatorprogram_id'])->label(false) ?>



    <div class="form-group">
        <label for="refindikatorprogram_id">Refindikatorprogram</label>
        <input type="text" id="refindikatorprogram_id" class="form-control" value="<?= $model->refindikatorprogram_id ?>" readonly>
    </div>
    ...
    <div class="form-group">
        <label for="refbidang_id">Bidang</label>
        <input type="text" id="refbidang_id" class="form-control" value="<?= $model->refBidang->nama_bidang ?>" readonly>
    </div>
    ...
    <?= $form->field($model, 'uraian_sasaranprogram')->hiddenInput()->label(false) ?>

    <div class="form-group">
        <label for="uraian_sasaranprogram">Uraian Sasaran Program</label>
        <input type="text" id="uraian_sasaranprogram" class="form-control" value="<?= $model->uraian_sasaranprogram ?>" readonly>
    </div>

    <?= $form->field($model, 'uraian_indikatorprogram')->hiddenInput()->label(false) ?>

    <div class="form-group">
        <label for="uraian_indikatorprogram">Uraian Indikator Program</label>
        <input type="text" id="uraian_indikatorprogram" class="form-control" value="<?= $model->uraian_indikatorprogram ?>" readonly>
    </div>

    <?= $form->field($model, 'program_target')->hiddenInput()->label(false) ?>

    <div class="form-group">
        <label for="program_target">Program Target</label>
        <input type="text" id="program_target" class="form-control" value="<?= $model->program_target ?>" readonly>
    </div>

    <?= $form->field($model, 'program_satuan')->hiddenInput()->label(false) ?>

    <div class="form-group">
        <label for="program_satuan">Program Satuan</label>
        <input type="text" id="program_satuan" class="form-control" value="<?= $model->program_satuan ?>" readonly>
    </div>
