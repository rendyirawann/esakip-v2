...
$this->title = 'Perencanaan Sub Kegiatan - ' . $model->refKegiatan->nama_kegiatan;
...
$('#createModal').on('show.bs.modal', function (event) {
    ...
    $.ajax({
        url: '" . Url::to(['simona-cascadingsubkegiatan/create']) . "',
        type: 'GET',
        data: {
...
$('#createModalRincianBelanja').on('show.bs.modal', function (event) {
    ...
    // Ambil refsimonacascadingsubkegiatan_id dari tombol
    var refsimonacascadingsubkegiatan_id = button.data('refsimonacascadingsubkegiatan_id');
    var refcascadingkegiatan_id = button.data('refcascadingkegiatan_id');
    var refkegiatan_id = button.data('refkegiatan_id');
    var refcascadingsubkegiatan_id = button.data('refcascadingsubkegiatan_id');
    var refsubkegiatan_id = button.data('refsubkegiatan_id');
    ...
    modal.find('#refsimonacascadingsubkegiatan_id').val(refsimonacascadingsubkegiatan_id);
    modal.find('#refcascadingkegiatan_id').val(refcascadingkegiatan_id);
    modal.find('#refkegiatan_id').val(refkegiatan_id);
    modal.find('#refcascadingsubkegiatan_id').val(refcascadingsubkegiatan_id);
    modal.find('#refsubkegiatan_id').val(refsubkegiatan_id);
...
$.ajax({
    url: '" . Url::to(['simona-rincianbelanjacascadingsubkegiatan/create']) . "',
    type: 'GET',
    data: {
        refsimonacascadingsubkegiatan_id: refsimonacascadingsubkegiatan_id,
        refcascadingkegiatan_id: refcascadingkegiatan_id,
        refkegiatan_id: refkegiatan_id,
        refcascadingsubkegiatan_id: refcascadingsubkegiatan_id,
        refsubkegiatan_id: refsubkegiatan_id,
...
$this->registerJs("
    $('.btn-upload-keluaran').on('click', function () {
        ...
        var refsimonacascadingsubkegiatan_id = $(this).data('refsimonacascadingsubkegiatan_id');
        var refcascadingkegiatan_id = $(this).data('refcascadingkegiatan_id');
        var refkegiatan_id = $(this).data('refkegiatan_id');
        var refcascadingsubkegiatan_id = $(this).data('refcascadingsubkegiatan_id');
        var refsubkegiatan_id = $(this).data('refsubkegiatan_id');
        ...
        $(modalId).find('#refsimonacascadingsubkegiatan_id').val(refsimonacascadingsubkegiatan_id);
        $(modalId).find('#refcascadingkegiatan_id').val(refcascadingkegiatan_id);
        $(modalId).find('#refkegiatan_id').val(refkegiatan_id);
        $(modalId).find('#refcascadingsubkegiatan_id').val(refcascadingsubkegiatan_id);
        $(modalId).find('#refsubkegiatan_id').val(refsubkegiatan_id);
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Perencanaan Sub Kegiatan</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Perencanaan Sub Kegiatan</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Periode Perencanaan Cascading Sub Kegiatan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= \yii\helpers\Html::beginForm(['view-subkegiatan'], 'get', ['class' => 'form-inline']); ?>
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Data Perencanaan Cascading Sub Kegiatan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?> (Periode <?= $selectedPeriodValue ?>)
                        </h6>
                    </div>
                    <div class="card-body">
                                ...
                                <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                    ...
                                    <?php foreach ($dataProvider->getModels() as $model): ?>
                                        ...
                                        <?php if ($currentRefsasaranrenstraId !== $model->refCascadingProgram->refsasaranrenstra_id): ?>
                                            ...
                                            <tr>
                                                <th colspan="6" style="background-color: #e23c3c; color:white; white-space: normal;"><?= $model->refCascadingProgram->reftujuan->uraian_tujuan ?></th>
                                            </tr>
                                            <tr>
                                                <th colspan="6" style="background-color: #6ee15b; color:white; white-space: normal;"><?= $model->refCascadingProgram->sasaranRenstra->uraian_sasaranrenstra ?></th>
                                            </tr>
                                        ...
                                        <!-- Check if the cascading program has changed to display the program -->
                                        <?php if ($currentRefcascadingkegiatanId !== $model->refcascadingkegiatan_id): ?>
                                            <tr>
                                                <th colspan="6" style="background-color: #1DE9B6; color:white; white-space: normal;"><?= $model->refCascadingKegiatan->refKegiatan->kode_kegiatan ?> - <?= $model->refCascadingKegiatan->refKegiatan->nama_kegiatan ?></th>
                                            </tr>
                                            <?php $currentRefcascadingkegiatanId = $model->refcascadingkegiatan_id; ?>
                                        <?php endif; ?>

                                        <!-- Display Kegiatan and group by kegiatan_id -->
                                        <?php if ($currentRefsubkegiatanId !== $model->refsubkegiatan_id): ?>
                                            <tr>
                                                <th><?= $model->refSubkegiatan->kode_subkegiatan ?></th>
                                                <th colspan="2" style="white-space: normal;"><?= $model->refSubkegiatan->nama_subkegiatan ?></th>
                                                <th>Satuan</th>
                                                <th><?= $model->refPeriode->periode ?></th>
                                                <th>Anggaran</th>
                                            </tr>
                                            <?php $currentRefsubkegiatanId = $model->refsubkegiatan_id;
                                            // Calculate total anggaran for the current refprogram_id
                                            $totalAnggaran = SakipCascadingsubkegiatan::find()
                                                ->where(['refsubkegiatan_id' => $model->refsubkegiatan_id])
                                                ->andWhere(['refcascadingsubkegiatan_id' => $model->refcascadingsubkegiatan_id])
                                        ...
                                        <tr>
                                            ...
                                            <?php } elseif (isset($assignments['skpd'])) { ?>
                                                <th>
                                                    ...
                                                    <?= Html::button('<i class="fas fa-plus"></i>', [
                                                        ...
                                                        'data-refcascadingsubkegiatan_id' => $model->refcascadingsubkegiatan_id,
                                                        ...
                                                        'data-refsubkegiatan_id' => $model->refsubkegiatan_id,
                                                        'data-uraian_sasaransubkegiatan' => $model->uraian_sasaransubkegiatan,
                                                        'data-uraian_indikatorsubkegiatan' => $model->uraian_indikatorsubkegiatan,
                                                        'data-subkegiatan_target' => $model->subkegiatan_target,
                                                        'data-subkegiatan_satuan' => $model->subkegiatan_satuan,
                                                    ]) ?>
                                            ...
                                            <th style="white-space: normal;"><?= $model->uraian_sasaransubkegiatan ?> - <?= $model->uraian_indikatorsubkegiatan ?></th>
                                            <th><?= $model->subkegiatan_satuan ?></th>
                                            <th><?= $model->subkegiatan_target ?></th>
                                            <th><?= 'Rp. ' . number_format((float)$totalAnggaran, 0, ',', '.') ?></th>
                                        </tr>

                                        <!-- Accordion row -->
                                        <tr>
                                            <td colspan="6">
                                                <div class="accordion" id="accordion-<?= $model->refsubkegiatan_id ?>">
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="heading-<?= $model->refsubkegiatan_id ?>">
                                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-<?= $model->refsubkegiatan_id ?>" aria-expanded="false" aria-controls="collapse-<?= $model->refsubkegiatan_id ?>">
                                                                Detail Sub Kegiatan <?= $model->refSubkegiatan->nama_subkegiatan ?>
                                                            </button>
                                                        </h2>
                                                        <div id="collapse-<?= $model->refsubkegiatan_id ?>" class="accordion-collapse collapse" aria-labelledby="heading-<?= $model->refsubkegiatan_id ?>" data-bs-parent="#accordion-<?= $model->refsubkegiatan_id ?>">
                                                            <div class="accordion-body">
                                                                <?php
                                                                $totalAnggaranRincianKeseluruhan = 0; // Variable to track overall total of all rincian belanja
                                                                $details = SimonaCascadingsubkegiatan::find()->where(['refsubkegiatan_id' => $model->refsubkegiatan_id])->all();
                                                                foreach ($details as $detail):
                                                                ?>
                                                                    <h5><?= $detail->nama_tahapansubkegiatan ?></h5>
                                                                    <div class="dt-responsive table-responsive">
                                                                        <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                                                            <tr>
                                                                                <td><b>Kegiatan</b></td>
                                                                                <td><b><?= $model->refSubkegiatan->nama_subkegiatan ?></b></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Tanggal Mulai</td>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    ?>
                                                                                        ...
                                                                                        <?= Html::button('Tambah Upload Dokumen (BAPPEDA)', [
                                                                                            ...
                                                                                            'data-bs-toggle' => 'modal',
                                                                                            'data-bs-target' => '#uploadModal-' . $detail->refsimonacascadingsubkegiatan_id
                                                                                        ]) ?>
                                                                                    <?php } ?>
                                                                                    ...
                                                                                    <?= Html::button('View Document', [
                                                                                        ...
                                                                                        'data-bs-toggle' => 'modal',
                                                                                        'data-bs-target' => '#viewModal-' . $detail->refsimonacascadingsubkegiatan_id
                                                                                    ]) ?>
                                                                                </td>
                                                                                <td>
                                                                                    <?php
                                                                                    ...
                                                                                    ?>
                                                                                        ...
                                                                                        <?= Html::button('Tambah Upload Dokumen', [
                                                                                            'class' => 'btn btn-primary btn-sm',
                                                                                            'data-bs-toggle' => 'modal',
                                                                                            'data-bs-target' => '#uploadModalOpd-' . $detail->refsimonacascadingsubkegiatan_id
                                                                                        ]) ?>
                                                                                    <?php } ?>
                                                                                    ...
                                                                                    <?= Html::button('View Document', [
                                                                                        'class' => 'btn btn-info btn-sm',
                                                                                        'data-bs-toggle' => 'modal',
                                                                                        'data-bs-target' => '#viewModalOpd-' . $detail->refsimonacascadingsubkegiatan_id
                                                                                    ]) ?>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td colspan="2">
                                                                                    <?= Html::button('<i class="fas fa-edit">Update Tahapan Kegiatan</i>', [
                                                                                        ...
                                                                                        'data-url' => Url::to(['simona-cascadingsubkegiatan/update', 'refsimonacascadingsubkegiatan_id' => $detail->refsimonacascadingsubkegiatan_id])
                                                                                    ]) ?>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    ...
                                                                    <div class="modal fade" id="viewModal-<?= $detail->refsimonacascadingsubkegiatan_id ?>" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content" style="border-radius: 20px;">
                                                                                ...
                                                                                <div class="modal-body" style="padding-bottom:20px; padding-right:15px; padding-left:15px;">
                                                                                    <?php
                                                                                    // Fetch all documents associated with the refsimonacascadingsubkegiatan_id
                                                                                    $mediaFiles = SimonaMediacascadingsubkegiatan::findAll(['refsimonacascadingsubkegiatan_id' => $detail->refsimonacascadingsubkegiatan_id]);
                                                                                    ...
                                                                                    if ($mediaFiles) {
                                                                                        ...
                                                                                        foreach ($mediaFiles as $media) {
                                                                                            if ($media->file) {
                                                                                                ...
                                                                                                echo '<td>' . Html::a('Download ' . $media->file, ['simona-mediacascadingsubkegiatan/download', 'refsimonamediacascadingsubkegiatan_id' => $media->refsimonamediacascadingsubkegiatan_id], ['class' => 'btn btn-success', 'target' => '_blank']) . '</td>';
                                                                                                echo '</tr>';
                                                                                            }
                                                                                        }
                                                                                        echo '</table>';
                                                                    ...
                                                                    <!--  -->
                                                                    <div class="modal fade" id="uploadModal-<?= $detail->refsimonacascadingsubkegiatan_id ?>" tabindex="-1" aria-labelledby="uploadModalLabel" aria-hidden="true">
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content" style="border-radius: 20px;">
                                                                                <div class="modal-header">
                                                                                ...
                                                                                <div class="modal-body" style="padding-bottom:20px; padding-right:15px; padding-left:15px;">
                                                                                    <?php $form = ActiveForm::begin([
                                                                                        'action' => ['simona-mediacascadingsubkegiatan/create'],
                                                                                        'options' => ['enctype' => 'multipart/form-data']
                                                                                    ]); ?>

                                                                                    <?= $form->field($uploadModel, 'refsimonacascadingsubkegiatan_id')->hiddenInput(['value' => $detail->refsimonacascadingsubkegiatan_id])->label(false) ?>
                                                                    ...
                                                                    <!--  -->
                                                                    <!-- Modal to View the Document -->
                                                                    <div class="modal fade" id="viewModalOpd-<?= $detail->refsimonacascadingsubkegiatan_id ?>" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content" style="border-radius: 20px;">
                                                                                <div class="modal-header">
                                                                                ...
                                                                                <div class="modal-body" style="padding-bottom:20px; padding-right:15px; padding-left:15px;">
                                                                                    <?php
                                                                                    // Fetch all documents associated with the refsimonacascadingsubkegiatan_id
                                                                                    $mediaFiles = SimonaMediacascadingsubkegiatanOpd::findAll(['refsimonacascadingsubkegiatan_id' => $detail->refsimonacascadingsubkegiatan_id]);
                                                                                    ...
                                                                                    if ($mediaFiles) {
                                                                                        ...
                                                                                        foreach ($mediaFiles as $media) {
                                                                                            if ($media->file) {
                                                                                                ...
                                                                                                echo '<tr>';
                                                                                                echo '<td><b>Download</b></td>';
                                                                                                echo '<td>' . Html::a('Download ' . $media->file, ['simona-mediacascadingsubkegiatan-opd/download', 'refsimonamediacascadingsubkegiatanopd_id' => $media->refsimonamediacascadingsubkegiatanopd_id], ['class' => 'btn btn-success', 'target' => '_blank']) . '</td>';
                                                                                                echo '</tr>';
                                                                                            }
                                                                                        }
                                                                                        echo '</table>';
                                                                    ...
                                                                    <!--  -->
                                                                    <div class="modal fade" id="uploadModalOpd-<?= $detail->refsimonacascadingsubkegiatan_id ?>" tabindex="-1" aria-labelledby="uploadModalLabel" aria-hidden="true">
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content" style="border-radius: 20px;">
                                                                                <div class="modal-header">
                                                                                ...
                                                                                <div class="modal-body" style="padding-bottom:20px; padding-right:15px; padding-left:15px;">
                                                                                    <?php $form = ActiveForm::begin([
                                                                                        'action' => ['simona-mediacascadingsubkegiatan-opd/create'],
                                                                                        'options' => ['enctype' => 'multipart/form-data']
                                                                                    ]); ?>

                                                                                    <?= $form->field($uploadModelOpd, 'refsimonacascadingsubkegiatan_id')->hiddenInput(['value' => $detail->refsimonacascadingsubkegiatan_id])->label(false) ?>
                                                                    ...
                                                                    <div class="accordion mb-5" id="sub-accordion-<?= $detail->refsimonacascadingsubkegiatan_id ?>">
                                                                        <div class="accordion-item">
                                                                            <h2 class="accordion-header" id="sub-heading-<?= $detail->refsimonacascadingsubkegiatan_id ?>">
                                                                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#sub-collapse-<?= $detail->refsimonacascadingsubkegiatan_id ?>" aria-expanded="false" aria-controls="sub-collapse-<?= $detail->refsimonacascadingsubkegiatan_id ?>">
                                                                                    Rincian Belanja <?= $detail->nama_tahapansubkegiatan ?>
                                                                                </button>
                                                                            </h2>
                                                                            <div id="sub-collapse-<?= $detail->refsimonacascadingsubkegiatan_id ?>" class="accordion-collapse collapse" aria-labelledby="sub-heading-<?= $detail->refsimonacascadingsubkegiatan_id ?>" data-bs-parent="#sub-accordion-<?= $detail->refsimonacascadingsubkegiatan_id ?>">
                                                                                <div class="accordion-body">
                                                                                    <!-- Isi detail tingkat kedua -->
                                                                                    <?php
                                                                                    $totalAnggaranRincian = 0;
                                                                                    $expenses = SimonaRincianbelanjacascadingsubkegiatan::find()->where(['refsimonacascadingsubkegiatan_id' => $detail->refsimonacascadingsubkegiatan_id])->all();
                                                                                    if (empty($expenses)): ?>
                                                                                        ...
                                                                                        ?>
                                                                                            <h5>Rincian Belanja <?= Html::encode($detail->nama_tahapansubkegiatan) ?></h5>
                                                                                            <div class="dt-responsive table-responsive">
                                                                                                <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                                                                                    <tr>
                                                                                                        <th>Detail Belanja</th>
                                                                                                        <td><?= Html::encode($expense->detail_rincianbelanja) ?></td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        ?>
                                                                                                            <td colspan="2"><?= Html::button('Tambah Keluaran Dokumen', [
                                                                                                                                ...
                                                                                                                                'data-bs-toggle' => 'modal',
                                                                                                                                'data-bs-target' => '#uploadModalKeluaran-' . $expense->refsimonarincianbelanjacascadingsubkegiatan_id,
                                                                                                                                'data-refsimonacascadingsubkegiatan_id' => $expense->refsimonacascadingsubkegiatan_id,
                                                                                                                                ...
                                                                                                                                'data-refcascadingsubkegiatan_id' => $detail->refcascadingsubkegiatan_id,
                                                                                                                                'data-refsubkegiatan_id' => $detail->refsubkegiatan_id,
                                                                                                                            ]) ?>
                                                                                                                <!-- Button to open the modal to view the file -->
                                                                                                                <?= Html::button('View Document', [
                                                                                                                    'class' => 'btn btn-info btn-sm',
                                                                                                                    'data-bs-toggle' => 'modal',
                                                                                                                    'data-bs-target' => '#viewModalKeluaran-' . $expense->refsimonarincianbelanjacascadingsubkegiatan_id
                                                                                                                ]) ?>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td colspan="2">
                                                                                                            <?= Html::button('<i class="fas fa-edit">Update Rincian Belanja</i>', [
                                                                                                                ...
                                                                                                                'data-url' => Url::to(['simona-rincianbelanjacascadingsubkegiatan/update', 'refsimonarincianbelanjacascadingsubkegiatan_id' => $expense->refsimonarincianbelanjacascadingsubkegiatan_id])
                                                                                                            ]) ?>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                            ...
                                                                                            <!-- Modal to View the Document -->
                                                                                            <!-- Modal to View the Document -->
                                                                                            <div class="modal fade" id="viewModalKeluaran-<?= $expense->refsimonarincianbelanjacascadingsubkegiatan_id ?>" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
                                                                                                <div class="modal-dialog">
                                                                                                    <div class="modal-content" style="border-radius: 20px;">
                                                                                                        <div class="modal-header">
                                                                                                        ...
                                                                                                        <div class="modal-body" style="padding-bottom:20px; padding-right:15px; padding-left:15px;">
                                                                                                            ...
                                                                                                            $mediaFiles = SimonaKeluaranmediacascadingsubkegiatan::findAll(['refsimonarincianbelanjacascadingsubkegiatan_id' => $expense->refsimonarincianbelanjacascadingsubkegiatan_id]);
                                                                                                            ...
                                                                                                            if ($mediaFiles) {
                                                                                                                ...
                                                                                                                foreach ($mediaFiles as $media) {
                                                                                                                    if ($media->file) {
                                                                                                                        ...
                                                                                                                        echo '<tr>';
                                                                                                                        echo '<td><b>Download</b></td>';
                                                                                                                        echo '<td>' . Html::a('Download ' . $media->file, ['simona-keluaranmediacascadingsubkegiatan/download', 'refsimonakeluaranmediacascadingsubkegiatan_id' => $media->refsimonakeluaranmediacascadingsubkegiatan_id], ['class' => 'btn btn-success', 'target' => '_blank']) . '</td>';
                                                                                                                        echo '</tr>';
                                                                                                                    }
                                                                                                                }
                                                                                                                echo '</table>';
                                                                                            ...
                                                                                            <!--  -->
                                                                                            <div class="modal fade" id="uploadModalKeluaran-<?= $expense->refsimonarincianbelanjacascadingsubkegiatan_id ?>" tabindex="-1" aria-labelledby="uploadModalLabel" aria-hidden="true">
                                                                                                <div class="modal-dialog">
                                                                                                    <div class="modal-content" style="border-radius: 20px;">
                                                                                                        <div class="modal-header">
                                                                                                        ...
                                                                                                        <div class="modal-body" style="padding-bottom:20px; padding-right:15px; padding-left:15px;">
                                                                                                            <?php $form = ActiveForm::begin([
                                                                                                                'action' => ['simona-keluaranmediacascadingsubkegiatan/create'],
                                                                                                                'options' => ['enctype' => 'multipart/form-data']
                                                                                                            ]); ?>

                                                                                                            <?= $form->field($uploadModelKeluaran, 'refsimonarincianbelanjacascadingsubkegiatan_id')->hiddenInput(['value' => $expense->refsimonarincianbelanjacascadingsubkegiatan_id])->label(false) ?>
                                                                                                            <?= $form->field($uploadModelKeluaran, 'refsimonacascadingsubkegiatan_id')->hiddenInput(['id' => 'refsimonacascadingsubkegiatan_id'])->label(false) ?>
                                                                                                            ...
                                                                                                            <?= $form->field($uploadModelKeluaran, 'refsubkegiatan_id')->hiddenInput(['id' => 'refsubkegiatan_id'])->label(false) ?>
                                                                                                            <?= $form->field($uploadModelKeluaran, 'refcascadingsubkegiatan_id')->hiddenInput(['id' => 'refcascadingsubkegiatan_id'])->label(false) ?>
                                                                                    ...
                                                                                    <?php
                                                                                    // Get the subkegiatan's anggaran
                                                                                    $subkegiatanAnggaran = SakipCascadingsubkegiatan::find()
                                                                                        ->where([
                                                                                            'refcascadingsubkegiatan_id' => $detail->refcascadingsubkegiatan_id,
                                                                                            'refsubkegiatan_id' => $detail->refsubkegiatan_id,
                                                                                        ])
                                                                                    ...
                                                                                    <?php if ($totalAnggaranRincianKeseluruhan > $subkegiatanAnggaran): ?>
                                                                                        <div class="alert alert-danger mt-3">
                                                                                            <strong>Sisa Anggaran Sub Kegiatan Ini Sudah Habis</strong>
                                                                                        </div>
                                                                                    <?php else: ?>
                                                                                        <?= Html::button('<i class="fas fa-plus"> Tambah Rincian Belanja</i>', [
                                                                                            ...
                                                                                            'data-refsimonacascadingsubkegiatan_id' => $detail->refsimonacascadingsubkegiatan_id,
                                                                                            'data-refcascadingkegiatan_id' => $detail->refcascadingkegiatan_id,
                                                                                            'data-refcascadingsubkegiatan_id' => $detail->refcascadingsubkegiatan_id,
                                                                                            'data-refcascadingprogram_id' => $detail->refcascadingprogram_id,
                                                                                            'data-refkegiatan_id' => $detail->refkegiatan_id,
                                                                ...
                                                                <?php if (isset($remainingAnggaran)): ?>
                                                                    <div class="alert alert-danger mt-3">
                                                                ...
                                                                <?php else: ?>
                                                                    <p>No remaining budget calculated.</p>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content" style="border-radius: 20px;">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="createModalLabel">Tambah Rincian Kegiatan</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                        ...
                        <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content" style="border-radius: 20px;">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="updateModalLabel">Update Rincian</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <!-- The form will be loaded here -->
