...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#datarincianbelanjasimonacascadingsubkegiatan').off('submit').on('submit', function(e) {
            ...
            var anggaranField = $('#simonarincianbelanjacascadingsubkegiatan-anggaran_rincianbelanja');
...
$this->registerJs("
   // Add new JavaScript for formatting the anggaran input
    $(document).ready(function() {
        $('#simonarincianbelanjacascadingsubkegiatan-anggaran_rincianbelanja').on('input', function() {
            let value = $(this).val();
...
<div class="data-simona-rincianbelanjacascadingsubkegiatan-form">

    <?php
    $form = ActiveForm::begin([
        'id' => 'datarincianbelanjasimonacascadingsubkegiatan',
        'options' => ['enctype' => 'multipart/form-data'],
    ]);
    ?>


    <?= $form->field($model, 'refsimonacascadingsubkegiatan_id')->hiddenInput([
        'id' => 'refsimonacascadingsubkegiatan_id', // Berikan ID agar mudah diakses via JS
        'readonly' => true, // Agar tidak diubah secara manual
    ])->label(false) ?>
