...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#dataindikatorcascadingprogramtriwulan').off('submit').on('submit', function(e) {
...
<div class="sakip-indikatorcascadingprogram-triwulan-form">
    ...
    $form = ActiveForm::begin([
        'id' => 'dataindikatorcascadingprogramtriwulan',
        'options' => ['enctype' => 'multipart/form-data'],
        // 'enableAjaxValidation' => true,
    ]);
    ?>

    <?= $form->field($model, 'refindikatorprogram_id')->hiddenInput()->label(false) ?>
    ...
    <?= $form->field($model, 'triwulan_keterangan_pk_p')->textarea(['rows' => 6]) ?>

    <?= $form->field($model, 'triwulan_analisis')->hiddenInput(['rows' => 6])->label(false) ?>
