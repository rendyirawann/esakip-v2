                                                         ...
                                                         <?php if ($isAdmin): ?>
                                                             <td>
                                                                 <?= Html::button('<i class="fas fa-edit"></i>', [
                                                                     'class' => 'btn btn-success btn-sm btn-edit-cascadingprogram-triwulanpk',
                                                                     'title' => 'Update',
                                                                     'data-bs-toggle' => 'modal',
                                                                     'data-bs-target' => '#updateModal',
                                                                     'data-url' => Url::to(['update-triwulan-pk', 'refindikatorprogramtriwulan_id' => $indikator->refindikatorprogramtriwulan_id, 'reftriwulan_id' => $indikator->reftriwulan_id])
                                                                 ]) ?>
                                                             </td>
                                                         <?php endif; ?>
