                    ...
                    <div class="card-body" id="refresh">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= \yii\helpers\Html::beginForm(['index-anggaran-pkp-dev'], 'get', ['class' => 'form-inline']); ?>
                                    ...
                                    <?php foreach ($dataProvider->getModels() as $model): ?>
                                        ...
                                        if ($currentRefsasaranrenstraId !== $model->refsasaranrenstra_id): ?>
                                            ...
                                            <?php if ($currentRefprogramId !== $model->refprogram_id): ?>
                                                <tr>
                                                    <th colspan="<?= $isAdmin ? 7 : 6 ?>" style="background-color: #e23c3c; color:white; white-space: normal;">Program - <?= $model->refProgram->nama_program ?></th>
                                                </tr>
                                            <?php endif; ?>

                                            <?php if ($currentRefkegiatanId !== $model->refkegiatan_id): ?>
                                                <tr>
                                                    <th colspan="<?= $isAdmin ? 7 : 6 ?>" style="background-color: #6ee15b; color:white; white-space: normal;">Kegiatan - <?= $model->refKegiatan->nama_kegiatan ?></th>
                                                </tr>
                                                <tr>
                                            ...
                                            <?php if ($currentRefsubkegiatanId !== $model->refsubkegiatan_id): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ($isAdmin): ?>
                                                        <td>
                                                            <?php if (!empty($totalAnggaranrkt)): ?>
                                                                <?= Html::button('<i class="fas fa-edit"></i>', [
                                                                    'class' => 'btn btn-success btn-sm btn-edit-cascadingsubkegiatan-anggaranpkp',
                                                                    'title' => 'Update',
