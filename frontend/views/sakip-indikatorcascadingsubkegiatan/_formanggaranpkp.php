...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#dataindikatorcascadingsubkegiatan').off('submit').on('submit', function(e) {
            ...
            var anggaranField = $('#sakipindikatorcascadingsubkegiatan-anggaran_pk_p');
...
$this->registerJs("
   // Add new JavaScript for formatting the anggaran input
    $(document).ready(function() {
        $('#sakipindikatorcascadingsubkegiatan-anggaran_pk_p').on('input', function() {
            let value = $(this).val();
...
<div class="sakip-indikatorcascadingsubkegiatan-form">
    ...
    <?= $form->field($model, 'anggaran_pk_p')->textInput(['maxlength' => true, 'value' => $model->anggaran_pk_p ? number_format($model->anggaran_pk_p, 0, ',', '.') : ''])->label('Angggaran PK Perubahan') ?>
