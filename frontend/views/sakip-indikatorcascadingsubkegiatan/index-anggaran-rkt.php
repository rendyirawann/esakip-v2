...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-edit-anggaran-rkt', function () {
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= \yii\helpers\Html::beginForm(['index-anggaran-rkt'], 'get', ['class' => 'form-inline']); ?>
                                    ...
                                    <?php foreach ($dataProvider->getModels() as $model): ?>
                                        <?php if ($currentRefsasaranrenstraId !== $model->refsasaranrenstra_id): ?>
                                            ...
                                            <?php if ($currentRefkegiatanId !== $model->refkegiatan_id): ?>
                                                <tr>
                                                    <th colspan="5" style="background-color: #6ee15b; color:white; white-space: normal;">Kegiatan <?= $model->refKegiatan->nama_kegiatan ?></th>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?= Html::button('<i class="fas fa-edit"></i>', [
                                                            'class' => 'btn btn-success btn-sm btn-edit-anggaran-rkt',
                                                            'title' => 'Update',
                                                            'data-url' => Url::to(['update-anggaran-rkt', 'refindikatorsubkegiatan_id' => $model->refindikatorsubkegiatan_id])
                                                        ]) ?>
                                                    </td>
                                                </tr>
