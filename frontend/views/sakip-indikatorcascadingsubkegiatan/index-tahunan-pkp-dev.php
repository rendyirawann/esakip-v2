...
$this->title = 'e-SAKIP - PK Perubahan Tahunan Indikator Cascading Sub Kegiatan';
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">PK Perubahan Tahunan Indikator Cascading Sub Kegiatan</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">PK Perubahan Tahunan Indikator Cascading Sub Kegiatan</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Periode Data PK Perubahan Tahunan Indikator Cascading Sub Kegiatan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?>
                        </h6>
                    </div>
                    <div class="card-body" id="refresh">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= \yii\helpers\Html::beginForm(['index-tahunan-pkp-dev'], 'get', ['class' => 'form-inline']); ?>
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Data PK Perubahan Tahunan Indikator Cascading Sub Kegiatan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?> (Periode <?= $selectedPeriodValue ?>)
                        </h6>
                    </div>
                    <div class="card-body" id="refresh">
                                ...
                                foreach ($data as $indikator):
                                    ...
                                    if ($lastSubkegiatanId !== $indikator->refsubkegiatan_id):
                                        ...
                                        <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                            <thead>
                                                <tr>
                                                    <th colspan="<?= $isAdmin ? 10 : 9 ?>" style="background-color: #04A9F5; color: white; white-space:normal;">
                                                     ...
                                                     <td>
                                                         <?php if (!empty($indikator->target_pk)): ?>
                                                             <?= Html::button('<i class="fas fa-edit"></i>', [
                                                                 'class' => 'btn btn-success btn-sm btn-edit-subkegiatan-tahunanpkp',
                                                                 'title' => 'Update',
                                                                 'data-bs-toggle' => 'modal',
                                                                 'data-bs-target' => '#updateModal',
                                                                 'data-url' => Url::to(['update-target-pkp', 'refindikatorsubkegiatan_id' => $indikator->refindikatorsubkegiatan_id])
                                                             ]) ?>
                                                         <?php endif; ?>
                                                     </td>
                                                 <?php endif; ?>
