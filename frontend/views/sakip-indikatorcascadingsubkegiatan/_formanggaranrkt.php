    ...
    $(document).ready(function() {
        ...
        $('form#dataindikatorcascadingsubkegiatan').off('submit').on('submit', function(e) {
            ...
            var \$submitBtn = \$form.find(':submit'); // Temukan tombol submit
               ...
               // Format anggaran_rkt before submission
            var anggaranField = $('#sakipindikatorcascadingsubkegiatan-anggaran_rkt');
    ...
    if (response.success) {
        ...
        $('#refresh').load(location.href + ' #refresh > *');
                ...
                complete: function() {
                    ...
                    $('#sakipindikatorcascadingsubkegiatan-anggaran_rkt').trigger('input');
                }
            });
        });
    });
...
$this->registerJs("
   // Add new JavaScript for formatting the anggaran input
    $(document).ready(function() {
        $('#sakipindikatorcascadingsubkegiatan-anggaran_rkt').on('input', function() {
            let value = $(this).val();
...
<div class="sakip-indikatorcascadingsubkegiatan-form">
    ...
    <?= $form->field($model, 'anggaran_rkt')->textInput([
        'maxlength' => true,
        'value' => $model->anggaran_rkt ? number_format($model->anggaran_rkt, 0, ',', '.') : ''
    ]) ?>
    ...
    <?= $form->field($model, 'anggaran_pk')->hiddenInput(['maxlength' => true])->label(false) ?>
