...
/** @var frontend\models\search\SakipIndikatorcascadingsubkegiatanSearch $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="sakip-indikatorcascadingsubkegiatan-search">
    ...
    <?php // echo $form->field($model, 'anggaran_rkt') 
    ?>

    <?php // echo $form->field($model, 'target_rkt_p') 
    ?>

    <?php // echo $form->field($model, 'anggaran_rkt_p') 
    ?>

    <?php // echo $form->field($model, 'target_pk') 
    ?>

    <?php // echo $form->field($model, 'anggaran_pk') 
    ?>

    <?php // echo $form->field($model, 'target_pk_p') 
    ?>

    <?php // echo $form->field($model, 'anggaran_pk_p') 
    ?>
