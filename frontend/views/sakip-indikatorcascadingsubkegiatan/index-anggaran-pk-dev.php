...
$this->title = 'e-SAKIP - PK Anggaran Cascading Sub Kegiatan';
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">PK Anggaran Cascading Sub Kegiatan</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">PK Anggaran Cascading Sub Kegiatan</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Periode Data PK Anggaran Cascading Sub Kegiatan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= \yii\helpers\Html::beginForm(['index-anggaran-pk-dev'], 'get', ['class' => 'form-inline']); ?>
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Data PK Anggaran Cascading Sub Kegiatan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?> (Periode <?= $selectedPeriodValue ?>)
                        </h6>
                    </div>
                    <div class="card-body" id="refresh">
                                ...
                                <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                    ...
                                    <?php foreach ($dataProvider->getModels() as $model): ?>
                                        <?php if ($currentRefsasaranrenstraId !== $model->refsasaranrenstra_id): ?>
                                            <thead>
                                                <tr>
                                                    <th colspan="<?= $isAdmin ? 6 : 5 ?>" style="background-color: #04A9F5; color:white; white-space: normal;">
                                            ...
                                            <?php if ($currentRefprogramId !== $model->refprogram_id): ?>
                                                <tr>
                                                    <th colspan="<?= $isAdmin ? 6 : 5 ?>" style="background-color: #e23c3c; color:white; white-space: normal;">Program - <?= $model->refProgram->nama_program ?></th>
                                                </tr>
                                            ...
                                            <?php if ($currentRefkegiatanId !== $model->refkegiatan_id): ?>
                                                <tr>
                                                    <th colspan="<?= $isAdmin ? 6 : 5 ?>" style="background-color: #6ee15b; color:white; white-space: normal;">Kegiatan - <?= $model->refKegiatan->nama_kegiatan ?></th>
                                                </tr>
                                                <tr>
                                            ...
                                            <?php if ($currentRefsubkegiatanId !== $model->refsubkegiatan_id): ?>
                                                ...
                                                // Query to sum anggaran_rkt for the current refsubkegiatan_id and refcascadingsubkegiatan_id
                                                ...
                                                // Query to sum anggaran_pk for the current refsubkegiatan_id and refcascadingsubkegiatan_id
                                                        ...
                                                        <td>
                                                            <?php if (!empty($totalAnggaranrkt)): ?>
                                                                <?= Html::button('<i class="fas fa-edit"></i>', [
                                                                    'class' => 'btn btn-success btn-sm btn-edit-cascadingsubkegiatan-anggaranpk',
                                                                    'title' => 'Update',
                                                                    'data-bs-toggle' => 'modal',
                                                                    'data-bs-target' => '#updateModal',
                                                                    'data-url' => Url::to(['update-anggaran-pk', 'refindikatorsubkegiatan_id' => $model->refindikatorsubkegiatan_id])
                                                                ]) ?>
                                                            <?php endif; ?>
                                                        </td>
                                                    <?php endif; ?>
                        ...
                        <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content" style="border-radius: 20px;">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="updateModalLabel">Update Data PK Anggaran Cascading Sub Kegiatan</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <!-- The form will be loaded here -->
