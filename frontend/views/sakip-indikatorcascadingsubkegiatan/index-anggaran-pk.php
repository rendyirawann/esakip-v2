...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-edit-anggaran-pk', function () {
                                ...
                                <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                    ...
                                    <?php foreach ($dataProvider->getModels() as $model): ?>
                                        <?php if ($currentRefsasaranrenstraId !== $model->refsasaranrenstra_id): ?>
                                            <thead>
                                                <tr>
                                                    <th colspan="6" style="background-color: #04A9F5; color:white; white-space: normal;">
                                            ...
                                            <?php if ($currentRefprogramId !== $model->refprogram_id): ?>
                                                <tr>
                                                    <th colspan="6" style="background-color: #e23c3c; color:white; white-space: normal;">Program - <?= $model->refProgram->nama_program ?></th>
                                                </tr>
                                            ...
                                            <?php if ($currentRefkegiatanId !== $model->refkegiatan_id): ?>
                                                <tr>
                                                    <th colspan="6" style="background-color: #6ee15b; color:white; white-space: normal;">Kegiatan - <?= $model->refKegiatan->nama_kegiatan ?></th>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?= Html::button('<i class="fas fa-edit"></i>', [
                                                            'class' => 'btn btn-success btn-sm btn-edit-anggaran-pk',
                                                            'title' => 'Update',
