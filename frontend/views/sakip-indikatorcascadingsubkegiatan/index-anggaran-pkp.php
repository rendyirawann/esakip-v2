...
$this->title = 'e-SAKIP - PK Perubahan Anggaran Cascading Sub Kegiatan';
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-edit-anggaran-pkp', function () {
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">PK Perubahan Anggaran Cascading Sub Kegiatan</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">PK Perubahan Anggaran Cascading Sub Kegiatan</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Periode Data PK Perubahan Anggaran Cascading Sub Kegiatan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= \yii\helpers\Html::beginForm(['index-anggaran-pkp'], 'get', ['class' => 'form-inline']); ?>
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Data PK Perubahan Anggaran Cascading Sub Kegiatan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?> (Periode <?= $selectedPeriodValue ?>)
                        </h6>
                    </div>
                    <div class="card-body" id="refresh">
                            ...
                            <div class="dt-responsive table-responsive">
                                ...
                                <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                    ...
                                    <?php foreach ($dataProvider->getModels() as $model): ?>
                                        <?php
                                        if ($currentRefsasaranrenstraId !== $model->refsasaranrenstra_id): ?>
                                            <thead>
                                                <tr>
                                                    <th colspan="7" style="background-color: #04A9F5; color:white; white-space: normal;">
                                            ...
                                            <?php if ($currentRefprogramId !== $model->refprogram_id): ?>
                                                <tr>
                                                    <th colspan="7" style="background-color: #e23c3c; color:white; white-space: normal;">Program - <?= $model->refProgram->nama_program ?></th>
                                                </tr>
                                            <?php endif; ?>

                                            <?php if ($currentRefkegiatanId !== $model->refkegiatan_id): ?>
                                                <tr>
                                                    <th colspan="7" style="background-color: #6ee15b; color:white; white-space: normal;">Kegiatan - <?= $model->refKegiatan->nama_kegiatan ?></th>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <th style="background-color: #16537e; color:white; white-space: normal;">Anggaran PK</th>
                                                    <th style="background-color: #16537e; color:white; white-space: normal;">Anggaran PK Perubahan</th>
                                            ...
                                            <?php if ($currentRefsubkegiatanId !== $model->refsubkegiatan_id): ?>
                                                ...
                                                $subkegiatanRktSum = (new \yii\db\Query())
                                                    ...
                                                    ->where(['refsubkegiatan_id' => $model->refsubkegiatan_id, 'refcascadingsubkegiatan_id' => $model->refcascadingsubkegiatan_id])
                                                    ->andWhere(['refskpd_id' => $model->refskpd_id])
                                                    ->andWhere(['refperiode_id' => $model->refperiode_id])
                                                    ->scalar();
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= 'Rp. ' . number_format($totalAnggaranpk, 0, ',', '.'); ?></td>
                                                    <td><?= 'Rp. ' . number_format($totalAnggaranpkp, 0, ',', '.'); ?></td>
                                                    <td>
                                                        <?= Html::button('<i class="fas fa-edit"></i>', [
                                                            'class' => 'btn btn-success btn-sm btn-edit-anggaran-pkp',
                                                            'title' => 'Update',
                                                            'data-url' => Url::to(['update-anggaran-pkp', 'refindikatorsubkegiatan_id' => $model->refindikatorsubkegiatan_id])
                                                        ]) ?>
                                                    </td>
                                                </tr>
                                                <?php
                                                $currentRefsubkegiatanId = $model->refsubkegiatan_id;
                        ...
                        <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content" style="border-radius: 20px;">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="updateModalLabel">Update Data PK Perubahan Anggaran Cascading Sub Kegiatan</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <!-- The form will be loaded here -->
