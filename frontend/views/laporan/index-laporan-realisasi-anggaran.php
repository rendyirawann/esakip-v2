                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= \yii\helpers\Html::beginForm(['index-laporan-realisasi-anggaran'], 'get', ['class' => 'form-inline']); ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($data as $refsasaranrenstra_id => $entry): ?>
                                                        <tr style="background-color: #f2f2f2;">
                                                            <td colspan="11"><strong>Sasaran: <?= Html::encode($entry['uraian_sasaran']) ?></strong></td>
                                                        </tr>
                                                        <?php foreach ($entry['programs'] as $programId => $program): ?>
                                                            <tr>
                                                                <td align='center'><?= $no++ ?></td>
                                                                <td><?= Html::encode($program['nama_program']) ?></td>
                                                                <td align='right'>Rp. <?= Html::encode(number_format((float) ($program['anggaran_pk_p'] ?? 0), 2, ',', '.')) ?></td>
