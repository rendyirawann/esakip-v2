...
$this->registerJs("
 ...
 var content = $('#previewBox').html(); // Get the content from previewBox
        var selectedPeriodValue = '" . $selectedPeriodValue . "'; // Make sure to define the selected period value
var namaSkpd = ' $nama_skpd '; // Inject nama_skpd variable from PHP

        var printWindow = window.open('eSAKIP', '_blank');
   ...
   // Sertakan styling CSS yang sama pada jendela cetak
    printWindow.document.write('<title>Laporan Perjanjian Kinerja - Periode: ' + selectedPeriodValue + ' ( ' + namaSkpd + ' )</title>'); // Menambahkan nama SKPD pada title
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= \yii\helpers\Html::beginForm(['index-laporan-tapkin'], 'get', ['class' => 'form-inline']); ?>
                            ...
                            <div class="col-sm-12">
                                <div class="btn-group mb-3" role="group">
                                    ...
                                    <?= Html::a(
                                        ...
                                        [
                                            'cetak-laporan-tapkin',
                                            'refperiode_id' => $selectedPeriodId,
                                            'refskpd_id' => $selectedSkpdId,
                                            'refpenjabatskpd_id' => $refpenjabatskpd_id,
                                            'selected_date' => Yii::$app->request->get('selected_date')
                                        ],
                                        ['class' => 'btn btn-danger', 'target' => '_blank', 'data-pjax' => 0]
                                    ) ?>
                                    <?= Html::a(
                                        '<i class="fas fa-file-excel"></i> Excel (Hanya Tabel)',
                                        [
                                            'cetak-laporan-tapkin-excel',
                                            'refperiode_id' => $selectedPeriodId,
                                            'refskpd_id' => $selectedSkpdId,
                                            'refpenjabatskpd_id' => $refpenjabatskpd_id
                                        ],
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="isilaporan">
                                                            ...
                                                            <table class="tblPihak">
                                                                <tr>
                                                                    <td></td>
                                                                    <td>Lubuk Pakam, <span class="dynamicDate"><?= date('d F Y') ?></span></td>
                                                                </tr>
                                                                <tr>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td class="left" style="border: 1px solid black;"><?= Html::encode($namaProgram) ?></td>
...
<script>
    function updatePreviewDate() {
        ...
        if (selectedDate) {
            ...
            var dateElements = document.querySelectorAll('.dynamicDate');
