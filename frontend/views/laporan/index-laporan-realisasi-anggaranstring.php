                                                    ...
                                                    foreach ($data as $refsasaranrenstra_id => $entry): ?>
                                                        ...
                                                        <?php foreach ($entry['programs'] as $programId => $program): ?>
                                                            <tr>
                                                                ...
                                                                <?php for ($i = 0; $i < 4; $i++): ?>
                                                                    ...
                                                                    <td align='center'>
                                                                        <?= isset($program['quarterly'][$i]) ? Html::encode(number_format($program['quarterly'][$i]['triwulan_realisasi'], 2)) : '0' ?>
                                                                    </td>
                                                                <?php endfor; ?>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                        <tr>
                                                            ...
                                                            <?php for ($i = 0; $i < 4; $i++): ?>
                                                                ...
                                                                <td align='center'>
                                                                    <?= Html::encode(number_format($entry['total_quarterly_realisasi'][$i], 2)) ?>
                                                                </td>
                                                            <?php endfor; ?>
                                                        </tr>
                                                    <?php endforeach; ?>
