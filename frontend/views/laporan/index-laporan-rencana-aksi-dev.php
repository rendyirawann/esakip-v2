                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= \yii\helpers\Html::beginForm(['index-laporan-rencana-aksi-dev'], 'get', ['class' => 'form-inline']); ?>
                            ...
                            <div class="col-sm-12">
                                <div class="btn-group mb-3" role="group">
                                    ...
                                    <?= Html::a(
                                        ...
                                        ['cetak-rencana-aksi', 'refperiode_id' => $selectedPeriodId, 'refskpd_id' => $selectedSkpdId],
                                        ['class' => 'btn btn-danger', 'target' => '_blank', 'data-pjax' => 0]
                                    ) ?>
                                    <?= Html::a(
                                        '<i class="fas fa-file-excel"></i> Excel',
                                        ['cetak-rencana-aksi-excel', 'refperiode_id' => $selectedPeriodId, 'refskpd_id' => $selectedSkpdId],
                                            ...
                                            <table width='100%' border='0' cellpadding='0' cellspacing='0' class='tbdata' align='center'>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($groupedSubkegiatan as $refcascadingkegiatan_id => $subkegiatanGroup): ?>
                                                        ...
                                                        if ($firstItem->refCascadingKegiatan->refCascadingProgram->refProgram) {
                                                            $programName = $firstItem->refCascadingKegiatan->refCascadingProgram->refProgram->nama_program;
                                                            $programAnggaran = isset($anggaranPerProgram[$firstItem->refCascadingKegiatan->refCascadingProgram->refProgram->refprogram_id])
                                                                ? $anggaranPerProgram[$firstItem->refCascadingKegiatan->refCascadingProgram->refProgram->refprogram_id]
                                                                : 0;
                                                        }
                                                        ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style='text-align:center;white-space: normal;' rowspan="<?= $rowspan ?>">
                                                                <?= number_format($programAnggaran, 0, ',', '.') ?>
                                                            </td>
                                                            <td style='text-align:center;white-space: normal;' rowspan="<?= $rowspan ?>">
                                                                <?php
