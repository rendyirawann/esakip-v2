...
$pdfUrl = Url::to(['laporan/download-pdf-iku']); // Endpoint to generate and download PDF
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;"> <!-- Sesuaikan padding di sini -->
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll"> <!-- Mengatur margin menjadi 0 untuk mengurangi ruang -->
                            <i class="fas fa-pen-fancy"></i> Laporan Analisis Pencapaian Sasaran Triwulan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <!-- Dropdown filter untuk memilih periode -->
                                <?= \yii\helpers\Html::beginForm(['index-laporan-analisis-sasaran-triwulan-dev'], 'get', ['class' => 'form-inline']); ?>
                            ...
                            <div class="col-lg-6">
                                <!-- Dropdown filter untuk memilih triwulan -->
                                <div class="form-group">
                                    <?= \yii\helpers\Html::label('Pilih Triwulan:', 'reftriwulan_id', ['class' => 'mr-2']); ?>
                                    <?= \yii\helpers\Html::dropDownList(
                                        'reftriwulan_id',
                                        $selectedTriwulanId, // Pastikan ini diisi dengan nilai yang sesuai
                                        [
                                            '1' => 'Triwulan 1',
                                            '2' => 'Triwulan 2',
                                            '3' => 'Triwulan 3',
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-12">
                                <!-- Dropdown filter untuk memilih SKPD -->
                                <div class="form-group">
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-12">
                                <!-- Dropdown filter untuk memilih Sasaran Renstra -->
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <?= \yii\helpers\Html::submitButton('Tampil', ['class' => 'btn btn-primary mt-3']); ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="btn-group mb-3" role="group">
                                    ...
                                    <?= Html::a(
                                        ...
                                        [
                                            'cetak-analisis-sasaran-triwulan',
                                    ...
                                    <?= Html::a(
                                        ...
                                        [
                                            'cetak-analisis-sasaran-triwulan-excel',
                                            'refperiode_id' => $selectedPeriodId,
                                            'refskpd_id' => $selectedSkpdId,
                                            'reftriwulan_id' => $selectedTriwulanId,
                                            'refsasaranrenstra_id' => $selectedSasaranRenstraId
                                                    ...
                                                    <table class='tblRenstra'>
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <td colspan="2" class='header'>Triwulan <?= $selectedTriwulanId ?></td>
