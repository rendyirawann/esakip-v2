                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= \yii\helpers\Html::beginForm(['index-laporan-renstra-dev'], 'get', ['class' => 'form-inline']); ?>
                                        ...
                                        <table border=0 cellpadding=1 cellspacing=1 border=0 class="tbdata" width="100%">
                                            <tr>
                                                <td><span class="tebal">Visi RPJMD</span><br><br>
                                                    <table class='tblAtas'>
                                                        <?php foreach ($sasaranRenstra as $item): ?>
                                                            <tr>
                                                                <td>
                                                                    <ul>
                                                    ...
                                                    <table class='tblAtas'>
                                                        <?php foreach ($sasaranRenstra as $item): ?>
                                                            <tr>
                                                                <td>
                                                                    <ul>
                                                                        <li><?= Html::decode(strip_tags($item->refMisi->uraian_misi)) ?></li>
                                                                    </ul>
                                                                </td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    ...
                                                    <table class='tblAtas'>
                                                        <?php foreach ($sasaranRenstra as $item): ?>
                                                            <tr>
                                                                <td>
                                                                    <ul>
                                                                        <li><?= Html::decode(strip_tags($item->refTujuan->uraian_tujuan)) ?></li>
                                                                    </ul>
                                                                </td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    ...
                                                    <table class='tblAtas'>
                                                        <?php foreach ($sasaranRenstra as $item): ?>
                                                            <tr>
                                                                <td>
                                                                    <ul>
                                                                        <li><?= Html::decode(strip_tags($item->refSasaran->uraian_sasaran)) ?></li>
                                                                    </ul>
                                                                </td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                            ...
                                            <tr>
                                                <td><span class="tebal">Strategi Renstra</span><br><br>
                                                    <table class='tblAtas'>
                                                        <?php foreach ($strategiList as $strategi): ?>
                                                            <tr>
                                                                <td>
                                                                    <ul>
                                            ...
                                            <tr>
                                                <td><span class="tebal">Kebijakan Renstra</span><br><br>
                                                    <table class='tblAtas'>
                                                        <?php foreach ($kebijakanList as $kebijakan): ?>
                                                            <tr>
                                                                <td>
                                                                    <ul>
