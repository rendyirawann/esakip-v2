...
$this->registerJs("
$(document).on('click', '#btn-create-kegiatan', function() {
                                        ...
                                        <?php if ($currentRefsasaranrenstraId !== $model->refCascadingProgram->refsasaranrenstra_id): ?>
                                            ...
                                            <tr>
                                                <th colspan="6" style="background-color: #6ee15b; color:white; white-space: normal;">
                                                    (Sasaran)<br>
                                                    <?= isset($model->refCascadingProgram->sasaranRenstra) ? $model->refCascadingProgram->sasaranRenstra->uraian_sasaranrenstra : '-' ?>
                                                </th>
                                            </tr>
                                        ...
                                        <tr>
                                            <th>
                                                <?= Html::button('<i class="fas fa-edit"></i>', [
                                                    'class' => 'btn btn-success btn-sm btn-edit-kegiatan',
                                                    'title' => 'Update',
