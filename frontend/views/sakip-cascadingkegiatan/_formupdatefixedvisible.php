...
<div class="sakip-cascadingkegiatan-form">
    ...
    <?= $form->field($model, 'refcascadingprogram_id')->textInput(['disabled' => true, 'value' => $model->refcascadingprogram_id])->label('Cascadng Program ID') ?>
    ...
    <?= $form->field($model, 'refindikatorsasaranrenstra_id')->textInput(['disabled' => true, 'value' => $model->refIndikatorasaranRenstra->refindikatorsasaranrenstra_id])->label('Indikator Sasaran Renstra ID') ?>
