                                ...
                                <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                    ...
                                    <?php foreach ($cascadingPrograms as $cascadingProgram): ?>
                                        <?php if ($currentRefsasaranrenstraId !== $cascadingProgram->refsasaranrenstra_id): ?>
                                            <tr>
                                                <th colspan="6" style="background-color: #04A9F5; color:white; white-space: normal;"><?= $cascadingProgram->refmisi->uraian_misi ?></th>
                                            </tr>
                                            <tr>
                                                <th colspan="6" style="background-color: #e23c3c; color:white; white-space: normal;">(Tujuan)<?= $cascadingProgram->reftujuan->uraian_tujuan ?></th>
                                            </tr>
                                            <tr>
                                                <th colspan="6" style="background-color: #6ee15b; color:white; white-space: normal;">(Sasaran)<br><?= $cascadingProgram->sasaranRenstra->uraian_sasaranrenstra ?></th>
                                            </tr>
                                                        ...
                                                        <div id="collapse<?= $cascadingProgram->refcascadingprogram_id ?>" class="accordion-collapse collapse" aria-labelledby="heading<?= $cascadingProgram->refcascadingprogram_id ?>" data-bs-parent="#accordion<?= $cascadingProgram->refcascadingprogram_id ?>">
                                                            <div class="accordion-body">
                                                                ...
                                                                foreach ($penjabatModels as $penjabatModel): ?>
                                                                    <p><strong>Penjabat:</strong> <?= $penjabatModel->refPenjabatskpd->nama_penjabat ?></p>
                                                                    <p><strong>NIP:</strong> <?= $penjabatModel->refPenjabatskpd->nip_penjabat ?></p>
                                                                    <p><strong>Jabatan:</strong> <?= $penjabatModel->refPenjabatskpd->jabatan_eselon ?></p>
                                                                    <p><strong>Pangkat:</strong> <?= $penjabatModel->refPenjabatskpd->pangkat_eselon ?></p>
