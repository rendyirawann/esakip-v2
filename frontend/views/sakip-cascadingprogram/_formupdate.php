   ...
   $('#ref-periode-dropdown').change(function() {
    ...
    $('#sakipcascadingprogram-refsasaranrenstra_id').change(function() {
        ...
        if (refsasaranrenstra_id) {
            $.ajax({
                url: '" . Url::to(['sakip-cascadingprogram/get-indikator-sasaran']) . "',
                type: 'GET',
                ...
                error: function() {
                    alert('Error retrieving data for indicators.');
                },
                complete: function() {
                    hideLoading();
                }
...
<div class="sakip-cascadingprogram-form">
    ...
    <?= $form->field($model, 'refsasaranrenstra_id')->textInput(['disabled' => true, 'value' => $model->sasaranRenstra->uraian_sasaranrenstra])->label('Sasaran Renstra') ?>

    <?= $form->field($model, 'refindikatorsasaranrenstra_id')->textInput(['disabled' => true, 'value' => $model->refIndikatorSasaranRenstra->uraian_indikatorsasaranrenstra])->label('Indikator Sasaran Renstra') ?>

    <?= $form->field($model, 'refbidang_id')->textInput(['disabled' => true, 'value' => $model->refBidang->nama_bidang])->label('Bidang') ?>

    <?= $form->field($model, 'refprogram_id')->textInput(['disabled' => true, 'value' => $model->refProgram->nama_program])->label('Program') ?>

    <?= $form->field($model, 'refsasaran_id')->hiddenInput(['disabled' => true, 'value' => $model->refsasaran->uraian_sasaran])->label(false) ?>

    <?= $form->field($model, 'reftujuan_id')->hiddenInput(['disabled' => true, 'value' => $model->reftujuan->uraian_tujuan])->label(false) ?>

    <?= $form->field($model, 'refmisi_id')->hiddenInput(['disabled' => true, 'value' => $model->refmisi->uraian_misi])->label(false) ?>
