                ...
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i> Cascading Program - <?= Html::decode($nama_skpd) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                                ...
                                <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                    ...
                                    <?php foreach ($dataProvider->getModels() as $model): ?>
                                        <?php if ($currentRefsasaranrenstraId !== $model->refsasaranrenstra_id): ?>
                                            ...
                                            <tr>
                                                <th colspan="6" style="background-color: #e23c3c; color:white; white-space: normal"><?= $model->reftujuan->uraian_tujuan ?></th>
                                            </tr>
                                            <tr>
                                                <th colspan="6" style="background-color: #6ee15b; color:white; white-space: normal"><?= $model->refsasaran->uraian_sasaran ?></th>
                                            </tr>
                                                            ...
                                                            <div class="accordion-body">
                                                                ...
                                                                foreach ($penjabatModels as $penjabatModel): ?>
                                                                    ...
                                                                    <?= Html::button('<i class="fas fa-edit"></i>', [
                                                                        ...
                                                                        'data-url' => Url::to(['sakip-penjabatskpd-cascadingprogram/update', 'refpenjabatcascadingprogram_id' => $penjabatModel->refpenjabatcascadingprogram_id])
                                                                    ]) ?>
