                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php if (empty($groupedData)): ?>
                            <div class="alert alert-warning mt-4">Data tidak ditemukan untuk periode ini.</div>
                        <?php else: ?>
                                                    ...
                                                    <div class="list-group-item list-group-item-light p-3 mb-3 rounded">
                                                        ...
                                                        <ul class="list-unstyled ps-3">
                                                            <?php if (empty($sasaran->tujuanRenstra)): ?>
                                                                <li class="font-italic text-muted">Belum ada Tujuan Renstra.</li>
                                                            <?php else: ?>
                                                                <?php foreach ($sasaran->tujuanRenstra as $tujuanRenstra): ?>
                                                                    <li class="d-flex justify-content-between align-items-center py-1">
                                                                        <span><i class="fas fa-caret-right me-2 text-muted"></i><?= Html::decode($tujuanRenstra->uraian_tujuanrenstra) ?></span>
                                                                        <div class="btn-group" role="group">
                                                                            ...
                                                                            <?= Html::a('<i class="fas fa-trash-alt"></i>', ['delete', 'reftujuanrenstra_id' => $tujuanRenstra->reftujuanrenstra_id], [
                                                                                'class' => 'btn btn-outline-danger btn-sm',
                                                                                'title' => 'Hapus',
                                                                                'data' => ['confirm' => 'Yakin ingin menghapus item ini?', 'method' => 'post'],
                                                                            ]) ?>
                                                                        </div>
                                                                    </li>
                                                                <?php endforeach; ?>
