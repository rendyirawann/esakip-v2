...
$this->title = 'Sakip Tujuan Renstra';
...
$this->registerJs("
$('#createModalTujuanRenstra').on('show.bs.modal', function (event) {
    var modal = $(this);
    $.ajax({
        url: '" . Url::to(['sakip-tujuanrenstra/create']) . "',
        type: 'GET',
        success: function(data) {
            modal.find('#modalFormContentTujuanRenstra').html(data);
        }
    });
});
");
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i> Tujuan Renstra - <?= Html::decode($nama_skpd) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>Data SAKIP Tujuan Renstra</h5>
                        ...
                        <?php else: ?>
                            <?php foreach ($data as $item): ?>
                                <div class="card mt-4">
                                                ...
                                                <?php foreach ($item['uraian_tujuanrenstra'] as $tujuanRenstra): ?>
                                                    <li>
                                                        ...
                                                        <?= Html::button('<i class="fas fa-edit"></i>', [
                                                            ...
                                                            'data-url' => Url::to(['update', 'reftujuanrenstra_id' => $tujuanRenstra->reftujuanrenstra_id]) // Pass the id correctly
                                                        ]) ?>
                                    ...
                                    <?= Html::button('Tambah Data Tujuan Renstra', [
