                                                ...
                                                <div id="tujuanCollapse" class="collapse show">
                                                    <div class="card-body p-2">
                                                        ...
                                                        <table class="table table-bordered table-hover table-sm">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                $indicators = SakipTujuanrenstra::find()
                                                                ...
                                                                if (!empty($indicators)):
                                                                    foreach ($indicators as $indicator): ?>
                                                                        <tr>
                                                                            <td style="white-space: normal;"><?= Html::decode($indicator->uraian_tujuanrenstra) ?></td>
                                                                            <td class="text-center">
                                                                                <?= Html::button('<i class="fas fa-edit"></i>', [
                                                                                    ...
                                                                                    'data-url' => Url::to(['update', 'reftujuanrenstra_id' => $indicator['reftujuanrenstra_id']])
                                                                                ]) ?>
                                                                                <?= Html::a('<i class="fas fa-trash-alt"></i>', ['delete', 'reftujuanrenstra_id' => $indicator['reftujuanrenstra_id']], [
                                                                                    'class' => 'btn btn-danger btn-sm',
                                                                                    'title' => 'Delete',
                                                                                    'data' => [
                                                                                        'confirm' => 'Apakah Anda yakin ingin menghapus tujuan ini?',
                                                                                        'method' => 'post',
                                                                                    ],
                                                                                ]) ?>
                                                                            </td>
