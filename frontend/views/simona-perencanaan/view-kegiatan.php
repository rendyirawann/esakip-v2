        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?= Html::a(
                            '<i class="fas fa-arrow-left"></i> Kembali', // Teks dan Ikon pada Tombol
                            ['/simona-perencanaan/index'], // URL Tujuan
                            ['class' => 'btn btn-primary'] // Opsi HTML untuk styling
                        ) ?>
                    </div>
                    <!-- End Card -->
                                    ...
                                    <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                        ...
                                        foreach ($dataProvider->getModels() as $model): ?>
                                            ...
                                            <?php if ($currentRefsasaranrenstraId !== $model->refCascadingProgram->refsasaranrenstra_id): ?>
                                                ...
                                                <tr>
                                                    <th colspan="6" style="background-color: #6ee15b; color:white; white-space: normal;">(Sasaran)<?= $model->refCascadingProgram->sasaranRenstra->uraian_sasaranrenstra ?></th>
                                                </tr>
                                                ...
                                                <td colspan="6">
                                                    <div class="accordion" id="accordion-<?= $model->refcascadingkegiatan_id ?>">
                                                        <div class="accordion-item">
                                                            ...
                                                            <div id="collapse-<?= $model->refcascadingkegiatan_id ?>" class="accordion-collapse collapse" aria-labelledby="heading-<?= $model->refcascadingkegiatan_id ?>" data-bs-parent="#accordion-<?= $model->refkegiatan_id ?>">
                                                                <div class="accordion-body">
                                                                    <?php
                                                                    $totalAnggaranRincianKeseluruhan = 0; // Variable to track overall total of all rincian belanja

                                                                    // Ensure you include refcascadingkegiatan_id in the query
                                                                    $details = SimonaCascadingKegiatan::find()
                                                                        ->where(['refkegiatan_id' => $model->refkegiatan_id])
                                                                        ->andWhere(['refcascadingkegiatan_id' => $model->refcascadingkegiatan_id]) // Add refcascadingkegiatan_id
                                                                        ->all();
                                                                                ...
                                                                                <div id="sub-collapse-<?= $detail->refsimonacascadingkegiatan_id ?>" class="accordion-collapse collapse" aria-labelledby="sub-heading-<?= $detail->refsimonacascadingkegiatan_id ?>" data-bs-parent="#sub-accordion-<?= $detail->refsimonacascadingkegiatan_id ?>">
                                                                                    <div class="accordion-body">
                                                                                        <table class="table table-sm">
                                                                                            <tr>
                                                                                                <td style="width: 20%;" class="fw-bold">Dokumen Keluaran</td>
                                                                                                <td>
                                                                                                    <?php if (isset($assignments['skpd'])): ?>
                                                                                                        <?= Html::button('<i class="fas fa-upload"></i> Tambah Keluaran', [
                                                                                                            'class' => 'btn btn-primary btn-sm btn-upload-keluaran',
                                                                                                            'data-bs-toggle' => 'modal',
                                                                                                            'data-bs-target' => '#uploadModalKeluaran-' . $detail->refsimonacascadingkegiatan_id,
                                                                                                    ...
                                                                                                    <?= Html::button('<i class="fas fa-eye"></i> Lihat Dokumen', [
                                                                                                        'class' => 'btn btn-info btn-sm',
                                                                                                        'data-bs-toggle' => 'modal',
                                                                                                        'data-bs-target' => '#viewModalKeluaran-' . $detail->refsimonacascadingkegiatan_id
                                                                                                    ]) ?>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                        ...
                                                                                        <!-- Modal to View the Document -->
                                                                                        <div class="modal fade" id="viewModalKeluaran-<?= $detail->refsimonacascadingkegiatan_id ?>" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
                                                                                            <div class="modal-dialog">
                                                                                                <div class="modal-content" style="border-radius: 20px;">
                                                                                                    <div class="modal-header">
                                                                                                    ...
                                                                                                    <div class="modal-body" style="padding-bottom:20px; padding-right:15px; padding-left:15px;">
                                                                                                        ...
                                                                                                        $mediaFiles = SimonaKeluaranmediacascadingkegiatan::findAll(['refsimonacascadingkegiatan_id' => $detail->refsimonacascadingkegiatan_id]);
                                                                                        ...
                                                                                        <!--  -->
                                                                                        <div class="modal fade" id="uploadModalKeluaran-<?= $detail->refsimonacascadingkegiatan_id ?>" tabindex="-1" aria-labelledby="uploadModalLabel" aria-hidden="true">
                                                                                            <div class="modal-dialog">
                                                                                                <div class="modal-content" style="border-radius: 20px;">
                                                                                                    <div class="modal-header">
                                                                                                    ...
                                                                                                    <div class="modal-body" style="padding-bottom:20px; padding-right:15px; padding-left:15px;">
                                                                                                        ...
                                                                                                        <?= $form->field($uploadModelKeluaran, 'refsimonacascadingkegiatan_id')->hiddenInput(['value' => $detail->refsimonacascadingkegiatan_id])->label(false) ?>
