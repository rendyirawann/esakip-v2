                                                                                            ...
                                                                                            ?>
                                                                                                <div class="card mb-3">
                                                                                                    <div class="card-header d-flex justify-content-between align-items-center">
                                                                                                        <h5 class="mb-0">Rincian Belanja <?= $no++; ?></h5>
                                                                                                        <div>
                                                                                                            <button class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#viewModalRincian-<?= $expense->refsimonarincianbelanjacascadingkegiatan_id ?>">
                                                                                                                <i class="fa fa-eye"></i> <!-- Optional: Add an icon -->
                                                                                                            </button>
                                                                                                            <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#updateModalRincianBelanja" data-url="<?= Url::to(['simona-rincianbelanjacascadingkegiatan/update', 'refsimonarincianbelanjacascadingkegiatan_id' => $expense->refsimonarincianbelanjacascadingkegiatan_id]) ?>">
                                                                                                                <i class="fas fa-pencil-alt"></i> <!-- Optional: Add an icon -->
                                                                                                            </button>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                ...
                                                                                                <div class="modal fade" id="viewModalRincian-<?= $expense->refsimonarincianbelanjacascadingkegiatan_id ?>" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
                                                                                                    <div class="modal-dialog modal-lg">
                                                                                                        <div class="modal-content" style="border-radius: 20px;">
                                                                                                            <div class="modal-header">
                                                                                                                <h5 class="modal-title" id="viewModalLabel">Detail Rincian Belanja</h5>
                                                                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                                                            </div>
                                                                                                            <div class="modal-body" style="padding-bottom:20px; padding-right:15px; padding-left:15px;">
                                                                                                                <div class="dt-responsive table-responsive">
