...
<div class="sakip-cascadingprogram-form">
    ...
    <?= $form->field($model, 'refsasaran_id')->textInput(['disabled' => true, 'value' => $model->refsasaran->uraian_sasaran])->label('Sasaran') ?>

    <?= $form->field($model, 'reftujuan_id')->textInput(['disabled' => true, 'value' => $model->reftujuan->uraian_tujuan])->label('Tujuan') ?>

    <?= $form->field($model, 'refmisi_id')->textInput(['disabled' => true, 'value' => $model->refmisi->uraian_misi])->label('Misi') ?>
