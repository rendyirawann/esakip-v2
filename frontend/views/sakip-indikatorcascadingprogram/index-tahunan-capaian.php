...
$this->title = 'e-SAKIP - Capaian Tahunan Indikator Cascading Program';
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-edit-capaiantahunan', function () {
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Capaian Tahunan Indikator Cascading Program</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Capaian Tahunan Indikator Cascading Program</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Periode Data Capaian Tahunan Indikator Cascading Program - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= \yii\helpers\Html::beginForm(['index-tahunan-capaian'], 'get', ['class' => 'form-inline']); ?>
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Data Capaian Tahunan Indikator Cascading Program - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?> (Periode <?= $selectedPeriodValue ?>)
                        </h6>
                    </div>
                    <div class="card-body" id="refresh">
                                ...
                                foreach ($data as $indikator):
                                    ...
                                    if ($lastProgramId !== $indikator->refprogram_id):
                                        ...
                                        <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                            <thead>
                                                <tr>
                                                    <th colspan="8" style="background-color: #04A9F5; color: white; white-space:normal;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if (!empty($indikator->target_pk_p)): ?>
                                                        <?= Html::button('<i class="fas fa-edit"></i>', [
                                                            'class' => 'btn btn-success btn-sm btn-edit-capaiantahunan',
                                                            'title' => 'Update',
                                                            'data-url' => Url::to(['update-target-capaian', 'refindikatorprogram_id' => $indikator->refindikatorprogram_id])
                                                        ]) ?>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                        ...
                        <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content" style="border-radius: 20px;">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="updateModalLabel">Update Data Capaian Tahunan Cascading Program</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <!-- The form will be loaded here -->
