...
$this->title = 'e-SAKIP - RKT Indikator Cascading Program';
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">RKT Indikator Cascading Program</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">RKT Indikator Cascading Program</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Periode Data RKT Indikator Cascading Program - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= \yii\helpers\Html::beginForm(['index-rkt-dev'], 'get', ['class' => 'form-inline']); ?>
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Data RKT Indikator Cascading Program - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?> (Periode <?= $selectedPeriodValue ?>)
                        </h6>
                    </div>
                    ...
                    <div class="card-body" id="refresh">
                        ...
                        <?php else: ?>
                            <div class="dt-responsive table-responsive">
                                ...
                                $programCounter = 1; // Counter for numbering programs
                                        ...
                                        <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ($isAdmin): ?>
                                                        <th style="background-color: #e23c3c; color:white; white-space: normal;">Aksi</th>
                                                    <?php endif; ?>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <?php
                                            $no = 1; // Reset row counter for the new program
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $indikator->refCascadingProgram->program_target ?></td>
                                                <td><?= $indikator->target_rkt ?></td>
                                                <td style="white-space: normal;"><?= $indikator->keterangan ?></td>
                                                <?php if ($isAdmin): ?>
                                                    <td class="text-center align-middle">
                                                        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#updateModal" data-url="<?= Url::to(['update', 'refindikatorprogram_id' => $indikator->refindikatorprogram_id]) ?>">
                                            ...
                                            <?php
                                            // Check if the next entry belongs to a different program
                                            $next = $data[$key + 1] ?? null;
                        ...
                        <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content" style="border-radius: 20px;">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="updateModalLabel">Update Data RKT Cascading Program</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <!-- The form will be loaded here -->
