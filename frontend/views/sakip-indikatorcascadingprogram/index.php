...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-edit-rkt', function () {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?= Html::button('<i class="fas fa-edit"></i>', [
                                                        'class' => 'btn btn-success btn-sm btn-edit-rkt',
                                                        'title' => 'Update',
                                                        'data-url' => Url::to(['update', 'refindikatorprogram_id' => $indikator->refindikatorprogram_id])
                                                    ]) ?>
                                                </td>
                                            </tr>
                                            <?php
