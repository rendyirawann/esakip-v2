...
$this->registerJs("
$(document).on('click', '#btn-create-subkegiatan', function() {
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-edit-subkegiatan', function () {
                                ...
                                <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                    ...
                                    <?php foreach ($dataProvider->getModels() as $model): ?>
                                        ...
                                        <?php if ($currentRefsasaranrenstraId !== $model->refCascadingProgram->refsasaranrenstra_id): ?>
                                            ...
                                            <tr>
                                                <th colspan="6" style="background-color: #6ee15b; color:white; white-space: normal;">
                                                    <?= $model->refCascadingProgram?->sasaranRenstra?->uraian_sasaranrenstra ?? 'Sasaran Renstra Tidak Ditemukan' ?>
                                                </th>
                                        ...
                                        <?php if ($currentRefkegiatanId !== $model->refkegiatan_id): ?>
                                            <tr>
                                                <th colspan="6" style="background-color: #1DE9B6; color:white; white-space: normal;">
                                                    <?= ($model->refCascadingKegiatan?->refKegiatan?->kode_kegiatan . ' - ' . $model->refCascadingKegiatan?->refKegiatan?->nama_kegiatan) ?? 'N/A' ?>
                                                </th>
                                            </tr>
                                        ...
                                        <tr>
                                            <th>
                                                <?= Html::button('<i class="fas fa-edit"></i>', [
                                                    'class' => 'btn btn-success btn-sm btn-edit-subkegiatan',
                                                    'title' => 'Update',
