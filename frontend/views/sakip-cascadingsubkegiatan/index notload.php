            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body" id="refresh">
                        ...
                        <?= Html::button('<i class="fas fa-plus-square"></i> Data Cascading Sub Kegiatan', [
                            ...
                            <div class="dt-responsive table-responsive">
                                <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                    ...
                                    <?php foreach ($dataProvider->getModels() as $model): ?>
                                        ...
                                        <?php if ($currentRefcascadingprogramId !== $model->refprogram_id): ?>
                                            <tr>
                                            ...
                                            <?php $currentRefcascadingprogramId = $model->refprogram_id; ?>
                                        <?php endif; ?>
                                        ...
                                        <?php if ($currentRefsubkegiatanId !== $model->refsubkegiatan_id): ?>
                                            <tr>
                                                <th><?= isset($model->refSubkegiatan) ? $model->refSubkegiatan->kode_subkegiatan : '-' ?></th>

                                                <th colspan="2" style="white-space: normal;">
                                                    <?= isset($model->refSubkegiatan) ? $model->refSubkegiatan->nama_subkegiatan : '-' ?>
                                                </th>

                                                <th>Satuan</th>
                                                <th>Target <?= $model->refPeriode->periode ?></th>
                                                <th>Anggaran</th>
                                            </tr>
                                        ...
                                        <tr>
                                            <th>
                                                <?= Html::button('<i class="fas fa-edit"></i>', [
                                                    ...
                                                    'data-url' => Url::to(['update', 'refcascadingsubkegiatan_id' => $model->refcascadingsubkegiatan_id])
                                                ]) ?>
                                                <?= Html::a('<i class="fas fa-trash-alt"></i>', ['delete', 'refcascadingsubkegiatan_id' => $model->refcascadingsubkegiatan_id], [
                                            ...
                                            <th><?= 'Rp. ' . number_format((float)$model->subkegiatan_anggaran, 0, ',', '.') ?></th>
                                        </tr>
                                        <tr>
                                            <td colspan="6">
                                                <div class="accordion" id="accordion<?= $model->refcascadingsubkegiatan_id ?>">
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="heading<?= $model->refcascadingsubkegiatan_id ?>">
                                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?= $model->refcascadingsubkegiatan_id ?>" aria-expanded="false" aria-controls="collapse<?= $model->refcascadingsubkegiatan_id ?>">
                                                                Lihat Penjabat SKPD
                                                            </button>
                                                        </h2>
                                                        <div id="collapse<?= $model->refcascadingsubkegiatan_id ?>" class="accordion-collapse collapse" aria-labelledby="heading<?= $model->refcascadingsubkegiatan_id ?>" data-bs-parent="#accordion<?= $model->refcascadingsubkegiatan_id ?>">
                                                            <div class="accordion-body">
                                                                <?php
                                                                $penjabatModels = SakipPenjabatskpdCascadingsubkegiatan::findAll(['refcascadingsubkegiatan_id' => $model->refcascadingsubkegiatan_id]);
                                                                foreach ($penjabatModels as $penjabatModel): ?>
                                                                    ...
                                                                    <?= Html::a('<i class="fas fa-trash-alt"></i> Hapus Penjabat SKPD', [
                                                                        'sakip-penjabatskpd-cascadingsubkegiatan/delete',
                                                                        'refpenjabatcascadingsubkegiatan_id' => $penjabatModel->refpenjabatcascadingsubkegiatan_id,
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content" style="border-radius: 20px;">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="createModalLabel">Tambah Data SAKIP Cascading Sub Kegiatan</h5>
                        ...
                        <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content" style="border-radius: 20px;">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="updateModalLabel">Update Data SAKIP Cascading Sub Kegiatan</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <!-- The form will be loaded here -->
