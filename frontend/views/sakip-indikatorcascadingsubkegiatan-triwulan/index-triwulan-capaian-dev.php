...
$this->title = 'e-SAKIP - Capaian Triwulan Indikator Cascading Sub Kegiatan';
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Capaian Triwulan Indikator Cascading Sub Kegiatan</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Capaian Triwulan Indikator Cascading Sub Kegiatan</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Periode Data Capaian Triwulan Indikator Cascading Sub Kegiatan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Data Capaian Triwulan Indikator Cascading Sub Kegiatan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?> (Periode <?= $selectedPeriodValue ?>)
                        </h6>
                    </div>
                    <div class="card-body">
                        <!-- Flash messages -->
                                            ...
                                            if ($lastKegiatanId !== $indikator->refkegiatan_id):
                                                ...
                                                <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $indikator->refIndikatorCascadingSubkegiatan->target_rkt ?></td>
                                                        <td><?= $indikator->triwulan_realisasi ?></td>
                                                        <td><?= $indikator->triwulan_capaian ?></td>
                                                        <?php if ($isAdmin): ?>
                                                            <td>
                                                                <?= Html::button('<i class="fas fa-edit"></i>', [
                                                                    'class' => 'btn btn-success btn-sm btn-edit-subkegiatan-triwulancapaian',
                                                                    'title' => 'Update',
                                                                    'data-bs-toggle' => 'modal',
                                                                    'data-bs-target' => '#updateModal',
                                                                    'data-url' => Url::to(['update-triwulan-capaian', 'refindikatorsubkegiatantriwulan_id' => $indikator->refindikatorsubkegiatantriwulan_id, 'reftriwulan_id' => $indikator->reftriwulan_id])
                                                                ]) ?>
                                                            </td>
                                                        <?php endif; ?>
