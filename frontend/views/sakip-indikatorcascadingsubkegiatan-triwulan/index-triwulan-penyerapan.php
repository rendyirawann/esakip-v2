...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-edit-penyerapantriwulan', function () {
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= \yii\helpers\Html::beginForm(['index-triwulan-penyerapan'], 'get', ['class' => 'form-inline']); ?>
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                ...
                                <div class="d-flex flex-column">
                                    <?php for ($i = 1; $i <= 4; $i++): ?>
                                        <a href="<?= \yii\helpers\Url::to(['index-triwulan-penyerapan', 'refperiode_id' => $selectedPeriodId, 'reftriwulan_id' => $i]) ?>"
                                                        ...
                                                        <td>
                                                            <?php if (!empty($indikator->refIndikatorCascadingSubkegiatan->anggaran_pk_p)): ?>
                                                                <?= Html::button('<i class="fas fa-edit"></i>', [
                                                                    'class' => 'btn btn-success btn-sm btn-edit-penyerapantriwulan',
                                                                    'title' => 'Update',
                                                                    'data-url' => Url::to([
                                                                        'update-triwulan-penyerapan',
                                                                        'refindikatorsubkegiatantriwulan_id' => $indikator->refindikatorsubkegiatantriwulan_id,
