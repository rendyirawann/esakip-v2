...
$this->title = 'e-SAKIP - Penyerapan Anggaran';
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Penyerapan Anggaran</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Penyerapan Anggaran</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Periode Data Penyerapan Anggaran - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= \yii\helpers\Html::beginForm(['index-triwulan-penyerapan-dev'], 'get', ['class' => 'form-inline']); ?>
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Data Penyerapan Anggaran - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?> (Periode <?= $selectedPeriodValue ?>)
                        </h6>
                    </div>
                    <div class="card-body">
                        <!-- Flash messages -->
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                ...
                                <div class="d-flex flex-column">
                                    <?php for ($i = 1; $i <= 4; $i++): ?>
                                        <a href="<?= \yii\helpers\Url::to(['index-triwulan-penyerapan-dev', 'refperiode_id' => $selectedPeriodId, 'refskpd_id' => $selectedSkpdId, 'reftriwulan_id' => $i]) ?>"
                                                ...
                                                <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th style="background-color: #e23c3c; color: white; white-space:normal;">Anggaran PKP Tahun (Periode: <?= $selectedPeriodValue ?>)</th>
                                                            <th style="background-color: #e23c3c; color: white; white-space:normal;">Penyerapan Tahun (Periode: <?= $selectedPeriodValue ?>) (Triwulan <?= $selectedTriwulanId ?>)</th>
                                                             <?php if ($isAdmin): ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><?= 'Rp. ' . number_format((float)$indikator->refIndikatorCascadingSubkegiatan->anggaran_pk_p, 0, ',', '.') ?></th>

                                                        <th><?= 'Rp. ' . number_format((float)$indikator->triwulan_penyerapan_anggaran, 0, ',', '.') ?></th>
                                                         <?php if ($isAdmin): ?>
                                                             <td>
                                                                 <?php if (!empty($indikator->refIndikatorCascadingSubkegiatan->anggaran_pk_p)): ?>
                                                                     <?= Html::button('<i class="fas fa-edit"></i>', [
                                                                         'class' => 'btn btn-success btn-sm btn-edit-subkegiatan-triwulanpenyerapan',
                                                                         'title' => 'Update',
                                                                         'data-bs-toggle' => 'modal',
                                                                         'data-bs-target' => '#updateModal',
                                                                         'data-url' => Url::to(['update-triwulan-penyerapan', 'refindikatorsubkegiatantriwulan_id' => $indikator->refindikatorsubkegiatantriwulan_id, 'reftriwulan_id' => $indikator->reftriwulan_id])
                                                                     ]) ?>
                                                                 <?php endif; ?>
                                                             </td>
                                                         <?php endif; ?>
                ...
                <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content" style="border-radius: 20px;">
                            <div class="modal-header">
                                <h5 class="modal-title" id="updateModalLabel">Update Data Penyerapan Anggaran</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <!-- The form will be loaded here -->
