...
$this->title = 'e-SAKIP - PK Perubahan Triwulan Indikator Cascading Sub Kegiatan';
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">PK Perubahan Triwulan Indikator Cascading Sub Kegiatan</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">PK Perubahan Triwulan Indikator Cascading Sub Kegiatan</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Periode Data PK Perubahan Triwulan Indikator Cascading Sub Kegiatan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Data PK Perubahan Triwulan Indikator Cascading Sub Kegiatan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?> (Periode <?= $selectedPeriodValue ?>)
                        </h6>
                    </div>
                    <div class="card-body">
                        <!-- Flash messages -->
                                            ...
                                            if ($lastKegiatanId !== $indikator->refkegiatan_id):
                                                ...
                                                <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $indikator->refIndikatorCascadingSubkegiatan->target_pk_p ?></td>
                                                        ...
                                                        <td style="white-space:normal;"><?= $indikator->triwulan_keterangan ?></td>
                                                         <?php if ($isAdmin): ?>
                                                             <td>
                                                                 <?php if (!empty($indikator->refIndikatorCascadingSubkegiatan->target_pk)): ?>
                                                                     <?= Html::button('<i class="fas fa-edit"></i>', [
                                                                         'class' => 'btn btn-success btn-sm btn-edit-subkegiatan-triwulanpkp',
                                                                         'title' => 'Update',
                                                                         'data-bs-toggle' => 'modal',
                                                                         'data-bs-target' => '#updateModal',
                                                                         'data-url' => Url::to(['update-triwulan-pkp', 'refindikatorsubkegiatantriwulan_id' => $indikator->refindikatorsubkegiatantriwulan_id, 'reftriwulan_id' => $indikator->reftriwulan_id])
                                                                     ]) ?>
                                                                 <?php endif; ?>
                                                             </td>
                                                         <?php endif; ?>
                ...
                <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content" style="border-radius: 20px;">
                            <div class="modal-header">
                                <h5 class="modal-title" id="updateModalLabel">Update Data PK Perubahan Triwulan Cascading Sub Kegiatan</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <!-- The form will be loaded here -->
