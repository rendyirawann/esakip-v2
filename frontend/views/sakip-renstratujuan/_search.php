...
/** @var frontend\models\search\SakipRenstratujuanSearch $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="sakip-strategi-search">
    ...
    <?= $form->field($model, 'refrenstratujuan_id') ?>

    <?= $form->field($model, 'uraian_strategi') ?>
