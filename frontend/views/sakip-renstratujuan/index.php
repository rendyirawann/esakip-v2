...
/** @var frontend\models\search\SakipRenstratujuanSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'e-Sakip - Data Renstra Tujuan';
...
$this->registerJs("
    $('#createModal').on('show.bs.modal', function (event) {
        ...
        var modal = $(this);
        $.ajax({
            url: '" . Url::to(['sakip-renstratujuan/create']) . "',
            type: 'GET',
            data: {
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Renstra Tujuan</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Renstra Tujuan</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Periode Renstra Tujuan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i> Data SAKIP Renstra Tujuan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?> (Periode <?= $selectedPeriodValue ?>)
                        </h6>
                    </div>
                    <div class="card-body">
                                                            ...
                                                            <div id="sasaranCollapse" class="collapse show">
                                                                <div class="card-body p-2">
                                                                    ...
                                                                    <table class="table table-bordered table-hover table-sm">
                                                                        ...
                                                                        <tbody>
                                                                            <?php if (!empty($sasaranRenstra->renstraTujuan)): ?>
                                                                                <?php foreach ($sasaranRenstra->renstraTujuan as $renstraTujuan): ?>
                                                                                    <tr>
                                                                                        <td style="white-space: normal;"><?= Html::decode($renstraTujuan->uraian_renstratujuan) ?></td>
                                                                                        <td class="text-center">
                                                                                            <?= Html::button('<i class="fas fa-edit"></i>', [
                                                                                                ...
                                                                                                'data-url' => Url::to(['update', 'refrenstratujuan_id' => $renstraTujuan->refrenstratujuan_id])
                                                                                            ]) ?>
                                                                                            <?= Html::a('<i class="fas fa-trash-alt"></i>', ['delete', 'refrenstratujuan_id' => $renstraTujuan->refrenstratujuan_id], [
                                                                                                'class' => 'btn btn-danger btn-sm',
                                                                                                'title' => 'Delete',
                                                                                                'data' => [
                                                                                                    'confirm' => 'Apakah Anda yakin ingin menghapus strategi ini?',
                                                                                                    'method' => 'post',
                                                                                                ],
                                                                                            ]) ?>
                                                                                        </td>
                                                                            ...
                                                                            <?php else: ?>
                                                                                <tr>
                                                                                    <td colspan="2" class="text-center"><b><i>Belum ada Tujuan Renstra.</i></b></td>
                                                                                </tr>
                                                                            <?php endif; ?>
                                                                        </tbody>
                                                                    </table>
                                                                    ...
                                                                    <div class="text-end mt-2">
                                                                        <?= Html::button('<i class="fas fa-plus"></i> Tambah Tujuan Renstra', [
                                                                            'class' => 'btn btn-primary',
                                                                            'data-refsasaranrenstra' => $sasaranRenstra->refsasaranrenstra_id,
                                                                            'data-refperiode' => $sasaranRenstra->refperiode_id,
                                                                            'data-bs-toggle' => 'modal',
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content" style="border-radius: 20px;">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="createModalLabel">Tambah Data SAKIP Strategi Renstra</h5>
                        ...
                        <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content" style="border-radius: 20px;">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="updateModalLabel">Update Data SAKIP Strategi Renstra</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <!-- The form will be loaded here -->
