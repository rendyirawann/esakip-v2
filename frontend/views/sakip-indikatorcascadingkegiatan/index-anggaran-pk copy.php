                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Indikator Cascading Kegiatan PK Anggaran</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Indikator Cascading Kegiatan PK Anggaran</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i> Indikator Cascading Kegiatan PK Anggaran - <?= Html::decode($nama_skpd) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>Data RKT - TARGET INDIKATOR CASCADING KEGIATAN PK ANGGARAN</h5>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="d-flex flex-wrap">
                                    <?php foreach ($periodeList as $periode): ?>
                                        <a href="<?= \yii\helpers\Url::to(['index-anggaran-pk', 'refperiode_id' => $periode->refperiode_id]) ?>"
