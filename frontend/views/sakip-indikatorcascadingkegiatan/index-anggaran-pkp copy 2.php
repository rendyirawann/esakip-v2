                            ...
                            <div class="dt-responsive table-responsive">
                                ...
                                <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                    ...
                                    <?php foreach ($dataProvider->getModels() as $model): ?>
                                        <?php if ($currentRefsasaranrenstraId !== $model->refsasaranrenstra_id || $currentRefprogramId !== $model->refprogram_id): ?>
                                            <?php if ($currentRefsasaranrenstraId !== null && $currentRefprogramId !== null): ?>
                                                </tbody>
                                            <?php endif; ?>
                                            ...
                                            <thead>
                                                ...
                                                <tr>
                                                    <th colspan="5" style="background-color: #e23c3c; color:white; white-space: normal;">Program - <?= $model->refProgram->nama_program ?></th>
                                                </tr>
                                                <tr>
                                                    <th>No</th>
                                                    <th>Kegiatan</th>
