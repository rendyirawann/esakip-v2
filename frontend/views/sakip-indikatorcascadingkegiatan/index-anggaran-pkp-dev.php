...
$this->title = 'e-SAKIP - PK Perubahan Anggaran Cascading Kegiatan';
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">PK Perubahan Anggaran Cascading Kegiatan</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">PK Perubahan Anggaran Cascading Kegiatan</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Periode Data PK Perubahan Anggaran Cascading Kegiatan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Data PK Perubahan Anggaran Cascading Kegiatan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?> (Periode <?= $selectedPeriodValue ?>)
                        </h6>
                    </div>
                    <div class="card-body">
                                        ...
                                        <?php if ($currentRefprogramId !== $model->refprogram_id): ?>
                                            ...
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="background-color: #6ee15b; color:white; white-space: normal;">Anggaran PK</th>
                                                    <th style="background-color: #6ee15b; color:white; white-space: normal;">Anggaran PK Perubahan</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <?php endif; ?>
