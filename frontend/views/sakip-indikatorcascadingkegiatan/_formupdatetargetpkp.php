...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#dataindikatorcascadingkegiatan').off('submit').on('submit', function(e) {
...
<div class="sakip-indikatorcascadingkegiatan-form">

    <?php
    $form = ActiveForm::begin([
        'id' => 'dataindikatorcascadingkegiatan',
    ...
    <?= $form->field($model, 'target_pk_p')->textInput(['maxlength' => true])->label('Target PK Perubahan') ?>
    ...
    <?= $form->field($model, 'keterangan_pk_p')->textarea(['rows' => 2]) ?>
