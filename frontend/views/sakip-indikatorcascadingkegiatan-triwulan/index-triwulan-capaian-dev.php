...
$this->title = 'e-SAKIP - Capaian Triwulan Indikator Cascading Kegiatan';
...
$('#createModal').on('show.bs.modal', function (event) {
    var modal = $(this);
    $.ajax({
        url: '" . Url::to(['sakip-indikatorcascadingkegiatan-triwulan/create']) . "',
        type: 'GET',
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Capaian Triwulan Indikator Cascading Kegiatan</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Capaian Triwulan Indikator Cascading Kegiatan</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Periode Data Capaian Triwulan Indikator Cascading Kegiatan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= \yii\helpers\Html::beginForm(['index-triwulan-capaian-dev'], 'get', ['class' => 'form-inline']); ?>
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #04A9F5; padding: 8px;">
                        <h6 style="color: white; margin: 0; cursor: pointer;" id="toggleAll">
                            <i class="fas fa-pen-fancy"></i>Data Capaian Triwulan Indikator Cascading Kegiatan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?> (Periode <?= $selectedPeriodValue ?>)
                        </h6>
                    </div>
                    <div class="card-body">
                        <!-- Flash messages -->
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                ...
                                <div class="d-flex flex-column">
                                    <?php for ($i = 1; $i <= 4; $i++): ?>
                                        <a href="<?= \yii\helpers\Url::to(['index-triwulan-capaian-dev', 'refperiode_id' => $selectedPeriodId, 'refskpd_id' => $selectedSkpdId, 'reftriwulan_id' => $i]) ?>"
                            ...
                            <div class="col-sm-10" id="refresh">
                                <!-- Content -->
                                <?php if ($dataEmpty): ?>
                                        ...
                                        foreach ($data as $indikator):
                                            ...
                                            if ($lastKegiatanId !== $indikator->refkegiatan_id):
                                                ...
                                                <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap" style="font-size:xx-small;">
                                                    <thead>
                                                        <tr>
                                                            <th colspan="<?= $isAdmin ? 9 : 8 ?>" style="background-color: #04A9F5; color: white; white-space:normal;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th style="background-color: #e23c3c; color: white; white-space:normal;">Target Tahun (Periode: <?= $selectedPeriodValue ?>)</th>
                                                            <th style="background-color: #e23c3c; color: white; white-space:normal;">Realisasi (Periode: <?= $selectedPeriodValue ?>) (Triwulan <?= $selectedTriwulanId ?>)</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $indikator->refIndikatorCascadingKegiatan->target_rkt ?></td>
                                                        <td><?= $indikator->triwulan_realisasi ?></td>
                                                        <td><?= $indikator->triwulan_capaian ?></td>
                                                        <?php if ($isAdmin): ?>
                                                            <td>
                                                                <?= Html::button('<i class="fas fa-edit"></i>', [
                                                                    'class' => 'btn btn-success btn-sm btn-edit-kegiatan-triwulancapaian',
                                                                    'title' => 'Update',
                                                                    'data-bs-toggle' => 'modal',
                                                                    'data-bs-target' => '#updateModal',
                                                                    'data-url' => Url::to(['update-triwulan-capaian', 'refindikatorkegiatantriwulan_id' => $indikator->refindikatorkegiatantriwulan_id, 'reftriwulan_id' => $indikator->reftriwulan_id])
                                                                ]) ?>
                                                            </td>
                                                        <?php endif; ?>
                ...
                <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content" style="border-radius: 20px;">
                            <div class="modal-header">
                                <h5 class="modal-title" id="updateModalLabel">Update Data Capaian Triwulan Cascading Kegiatan</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <!-- The form will be loaded here -->
