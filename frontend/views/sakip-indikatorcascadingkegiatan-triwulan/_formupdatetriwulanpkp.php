...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#dataindikatorcascadingkegiatantriwulan').off('submit').on('submit', function(e) {
...
<div class="sakip-indikatorcascadingkegiatan-triwulan-form">

    <?php
    $form = ActiveForm::begin([
        'id' => 'dataindikatorcascadingkegiatantriwulan',
        'options' => ['enctype' => 'multipart/form-data'],
        // 'enableAjaxValidation' => true,
    ]);
    ?>

    <?= $form->field($model, 'refindikatorkegiatan_id')->hiddenInput()->label(false) ?>
    ...
    <?= $form->field($model, 'triwulan_keterangan')->textarea(['rows' => 2]) ?>
