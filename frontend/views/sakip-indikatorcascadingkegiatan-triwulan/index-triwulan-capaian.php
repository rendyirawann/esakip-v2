...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-edit-capaiantriwulan', function () {
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= \yii\helpers\Html::beginForm(['index-triwulan-capaian'], 'get', ['class' => 'form-inline']); ?>
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                ...
                                <div class="d-flex flex-column">
                                    <?php for ($i = 1; $i <= 4; $i++): ?>
                                        <a href="<?= \yii\helpers\Url::to(['index-triwulan-capaian', 'refperiode_id' => $selectedPeriodId, 'reftriwulan_id' => $i]) ?>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?= Html::button('<i class="fas fa-edit"></i>', [
                                                                'class' => 'btn btn-success btn-sm btn-edit-capaiantriwulan',
                                                                'title' => 'Update',
                                                                'data-url' => Url::to([
                                                                    'update-triwulan-capaian',
                                                                    'refindikatorkegiatantriwulan_id' => $indikator->refindikatorkegiatantriwulan_id,
