...
<div class="sakip-sasaranrenstra-form">
    ...
    <?= $form->field($model, 'uraian_sasaranrenstra')->hiddenInput(['rows' => 6])->label(false) ?>

    <div class="form-group">
        <label for="uraian_sasaranrenstra">Uraian Sasaran Renstra</label>
        <input type="text" id="uraian_sasaranrenstra" class="form-control" value="<?= Html::encode($model->uraian_sasaranrenstra ? $model->uraian_sasaranrenstra : 'Sasaran tidak ditemukan') ?>" disabled>
    </div>
    ...
    <?= $form->field($model, 'reftujuanrenstra_id')->hiddenInput(['rows' => 6])->label(false) ?>

    <?= $form->field($model, 'sasaranrenstra_isaktif')->hiddenInput(['rows' => 6])->label(false) ?>
