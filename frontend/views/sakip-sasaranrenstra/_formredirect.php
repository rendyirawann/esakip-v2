...
<div class="sakip-sasaranrenstra-form">
    ...
    <div id="additional-fields" style="display:none;">
        ...
        <?= $form->field($model, 'refsasaran_id')->dropDownList([], ['prompt' => 'Pilih Sasaran RPJMD', 'id' => 'sakip-sasaranrenstra-refsasaran_id'])->label('Pilih Sasaran RPJMD') ?>
        ...
        <?= $form->field($model, 'sasaranrenstra_isaktif')->hiddenInput(['value' => 'T'])->label(false) ?>
