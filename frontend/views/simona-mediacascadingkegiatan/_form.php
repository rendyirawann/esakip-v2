...
/** @var backend\models\SimonaMediacascadingkegiatan$model */
...
$this->registerJs("
    ...
    $(document).ready(function() {
        ...
        $('form#datasimonamediacascadingkegiatan').off('submit').on('submit', function(e) {
...
<div class="data-simona-mediacascadingkegiatan-form">
    ...
    <?php $form = ActiveForm::begin([
        'id' => 'datasimonamediacascadingkegiatan',
        'action' => ['simona-mediacascadingkegiatan/create'],
        'options' => ['enctype' => 'multipart/form-data']
    ]); ?>

    <?= $form->field($model, 'refsimonacascadingkegiatan_id')->hiddenInput(['id' => 'simona-mediacascadingkegiatan-refsimonacascadingkegiatan_id'])->label(false) ?>
