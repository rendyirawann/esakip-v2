                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-sm table-striped align-middle text-center">
                                                        <thead class="table-secondary">
                                                            <!-- Nama SKPD ditempatkan di bagian atas tabel menggunakan colspan -->
                                                            <tr>
                                                                <th colspan="15" class="text-center"><?= Html::encode($skpd->nama_skpd) ?></th>
                                                            </tr>
                                                            <tr>
                                                                <th>No</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($renstraData as $sasaranItem):
                                                                ...
                                                                foreach ($indikatorList as $index => $indikatorItem):
                                                                    ...
                                                                    // Tampilkan kolom nomor dan uraian_sasaran hanya pada baris pertama indikator
                                                                    if ($index === 0) {
                                                                        echo '<td rowspan="' . $indikatorCount . '">' . $no++ . '</td>';
                                                                        echo '<td style="white-space: normal; word-wrap: break-word;" rowspan="' . $indikatorCount . '" class="text-start">' . Html::encode($sasaranItem['uraian_sasaran']) . '</td>';
                                                                    }

                                                                    // Tampilkan indikator dan triwulan-nya
                                                                    echo '<td style="white-space: normal; word-wrap: break-word;">' . Html::encode($indikatorItem['uraian_indikator']) . '</td>';

                                                                    foreach ($indikatorItem['triwulan'] as $tw) {
                                                                        echo '<td>' . Html::encode($tw->triwulan_realisasi) . '</td>';
                                                                        echo '<td>' . Html::encode($tw->triwulan_capaian) . ' ' . Html::encode($tw->refIndikatorsasaranrenstra->indikatorsasaranrenstra_satuan ?? '') . '</td>';
                                                                    }
