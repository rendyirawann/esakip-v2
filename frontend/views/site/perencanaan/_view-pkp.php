...
<div class="title">
    ...
    <h5 class="tbdata">
        <center>Perjanjian Kinerja Perubahan Tahunan - <?= Html::encode(ucwords(strtolower($nama_skpd))) ?><br>Periode <?= $selectedPeriodValue ?></center>
    </h5>
</div>
<hr>
<br>
                        ...
                        ?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style='text-align:center;'><?= Html::encode(strip_tags($indikator->target_pk_p)) ?></td>
                                </tr>
