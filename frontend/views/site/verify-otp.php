        ...
        <div class="auth-form">
            <div class="card my-5 mx-3">
                ...
                <div class="card-body">
                    ...
                    <?= $form->field($model, 'otp')->textInput(['autofocus' => true])->label('Kode OTP') ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12">
                            <?= Html::submitButton('Verifikasi Akun', ['class' => 'btn btn-primary btn-block mt-2', 'name' => 'verify-otp-button']) ?>
                        </div>
                        <!-- /.col -->
                    </div>
