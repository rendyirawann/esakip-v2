...
<div class="user-form">
    ...
    <?= $form->field($model, 'nama_user')->hiddenInput(['maxlength' => true])->label(false) ?>

    <?= $form->field($model, 'refskpd_id')->hiddenInput(['maxlength' => true])->label(false) ?>

    <?= $form->field($model, 'kode_group')->hiddenInput(['maxlength' => true])->label(false) ?>

    <?= $form->field($model, 'refpegawai_id')->hiddenInput(['maxlength' => true])->label(false) ?>
