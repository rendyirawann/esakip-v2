                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <?php if (isset($counts[$triwulanId])): ?>
                                                            ...
                                                            <td>
                                                                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modalDetail00_69_<?= $triwulanId ?>">
                                                                    <?= $counts[$triwulanId]['capaian_00_69']; ?>
                                                                </button>
                                                            </td>
                                                            <td>
                                                                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modalDetail70_99_<?= $triwulanId ?>">
                                                                    <?= $counts[$triwulanId]['capaian_70_99']; ?>
                                                                </button>
                                                            </td>
                                                            <td><button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modalDetail100<?= $triwulanId ?>">
                                                                    <?= $counts[$triwulanId]['capaian_100']; ?>
                                                                </button>
                                                            <td>
                                                                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modalDetailLebih100_<?= $triwulanId ?>">
                                                                    <?= $counts[$triwulanId]['capaian_lebih_100']; ?>
                                                                </button>
                                                            </td>
                                                            <td>
                                                                <span class="badge badge-info"><?= $counts[$triwulanId]['total']; ?></span>
                                                            </td>
                                                        <?php else: ?>
                                                            <td colspan="6"></td>
                                                        <?php endif; ?>
                                                    ...
                                                    <!-- Modal 00-69.99% -->
                                                    <div class="modal fade" id="modalDetail00_69_<?= $triwulanId ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-xl" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title">Detail Capaian 00-69.99% - <?= $label ?></h5>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <?php foreach ($indikatorData as $indikator): ?>
                                                                        <?php if ($indikator->reftriwulan_id == $triwulanId && floatval($indikator->triwulan_capaian) < 70): ?>
                                                                            <p><?= Html::encode($indikator->refIndikatorsasaranrenstra->uraian_indikatorsasaranrenstra); ?></p>
                                                                        <?php endif; ?>
                                                                    <?php endforeach; ?>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <!-- Modal 70-99.99% -->
                                                    <div class="modal fade" id="modalDetail70_99_<?= $triwulanId ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-xl" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title">Detail Capaian 70-99.99% - <?= $label ?></h5>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <?php foreach ($indikatorData as $indikator): ?>
                                                                        <?php if ($indikator->reftriwulan_id == $triwulanId && floatval($indikator->triwulan_capaian) >= 70 && floatval($indikator->triwulan_capaian) < 100): ?>
                                                                            <p><?= Html::encode($indikator->refIndikatorsasaranrenstra->uraian_indikatorsasaranrenstra); ?></p>
                                                                        <?php endif; ?>
                                                                    <?php endforeach; ?>
                                                                </div>
                                                    ...
                                                    <!-- Modal 100% -->
                                                    <div class="modal fade" id="modalDetail100<?= $triwulanId ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-xl" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title">Detail Capaian 100% - <?= $label ?></h5>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <?php foreach ($indikatorData as $indikator): ?>
                                                                        <?php if ($indikator->reftriwulan_id == $triwulanId && floatval($indikator->triwulan_capaian) == 100): ?>
                                                                            <p><?= Html::encode($indikator->refIndikatorsasaranrenstra->uraian_indikatorsasaranrenstra); ?></p>
                                                                        <?php endif; ?>
                                                                    <?php endforeach; ?>
                                                                </div>
                                                    ...
                                                    <!-- Modal Melebihi 100% -->
                                                    <div class="modal fade" id="modalDetailLebih100_<?= $triwulanId ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-xl" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title">Detail Capaian >100% - <?= $label ?></h5>
