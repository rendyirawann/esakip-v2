...
class AppAsset extends AssetBundle
{
    ...
    public $css = [
        ...
        // Tema kustom eSakip frontend (teal) — dimuat paling akhir agar override diterapkan.
        'css/esk-frontend.css',
    ];
    public $js = [
        ...
        // Sembunyikan tombol/tab "Perubahan" di seluruh halaman frontend.
        'js/esk-hide-perubahan.js',
    ];
    public $depends = [
        'yii\web\YiiAsset',
